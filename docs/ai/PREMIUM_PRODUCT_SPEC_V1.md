...
### Reguli de proces (adăugate 2026-07-08, la închiderea fazei de design)

**Fără implementare „după inspirație".** Orice schimbare răspunde DA la cel puțin una: rezolvă o problemă observată? / reduce click-uri? / crește claritatea? / a fost cerută de utilizatori? / e necesară tehnic? Altfel → backlog. Ciclul „încă un badge, încă un buton, încă un efect" e cel care transformă premium în încărcat.

**Gândire în versiuni, nu în perfecțiune.** v1 planner utilizabil → v1.1 schimbare rețete → v1.2 search → v1.3 undo → v2 nutriție → v3 istoric → v4 AI. Versiunile obligă la a termina lucruri.

**Product Freeze: cu 48h înainte de orice release nu se mai adaugă funcționalități.** Doar bugfix, polish, QA, responsive, accesibilitate. Pentru deadline-ul de 22 iulie: freeze din 20 iulie.

**Obiectivul celor două săptămâni (reformulat):** nu „cel mai bun planner", ci **primul planner pe care oamenii îl folosesc fără explicații.** Testul: cineva intră, generează, schimbă două rețete, înțelege costul, vede lista și spune „aha, chiar îmi e util".

**Protocolul primei runde de testare** (imediat ce preview-ul e stabil, 5-10 oameni): nu întrebăm „îți place?". Spunem „planifică-ți mesele pentru săptămâna viitoare", apoi tăcem și observăm. Fiecare ezitare de peste 3-5 secunde = candidat de îmbunătățire.
