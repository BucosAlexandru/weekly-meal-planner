...
|---|---|---|---|---|---|
| 5 | **Sushi** | local-webp | ✓ curated local | ⚠ unusual | no |
| 12 | **Dhal** | local-webp | ✓ curated local | ✓ | no |
| 39 | **Poutine** | local-webp | ✓ curated local | ⚠ unusual | no |
| 149 | **Pozole** | local-webp | ✓ curated local | ✓ | no |
| 181 | **Tonkotsu Ramen** | local-webp | ✓ curated local | ✓ | no |
| 182 | **Shoyu Ramen** | wikipedia | ⚠ wikipedia (verify match) | ? (external) | no |
| 183 | **Miso Ramen** | local-webp | ✓ curated local | ✓ | no |
...
| 16 | **Pad Thai** | wikipedia | ⚠ wikipedia (verify match) | ? (external) | no |
