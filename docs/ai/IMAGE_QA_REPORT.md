...
Generated by `scripts/audit-images.mjs` on 2026-08-25.
...
|---|---|---|---|---|
| **1. Local image override** | 85 | Curated `<img>` from `public/images/<slug>.{webp,jpg}` | curated URL | ✓ same-origin asset, always reaches |
| **2. Mapped external image** | 141 | Spoonacular/Wikipedia `<img>` from `recipe-images.js` | mapped URL | mostly (URL liveness not asserted from sandbox) |
...
| **4. Fallback emoji** | 11 | Emoji 🍽️ in SSR, nothing else | **cover2.jpg ❌** | ✓ user sees emoji |

Total recipes: 238. Buckets 3 + 4 = **11 recipes that
...
## Bucket 4 — Fallback emoji (SSR emoji, **no URL anywhere** — 11 recipes)
...
| With local override (`public/images/<slug>.{jpg,webp}`) | 85 |
| SSR renders emoji (buckets 3 + 4) | 11 |
| SSR renders `<img>` (buckets 1 + 2) | 226 |
| Flagship recipes | 20 |
...
| 172 | Clam Chowder | USA | local-domain | MAP_DIVERGENCE | **P3** | — |
...
| 215 | Greek Salad | Greece | wikipedia | — | **P3** | — |
| 216 | Caprese Salad | Italy | wikipedia | — | **P3** | — |
| 217 | Lasagna | Italy | wikipedia | — | **P3** | — |
| 218 | Salade Niçoise | France | wikipedia | — | **P3** | — |
| 219 | Beef Stroganoff | Russia | wikipedia | — | **P3** | — |
| 222 | Coq au Vin | France | wikipedia | — | **P3** | — |
| 223 | Bigos | Poland | wikipedia | — | **P3** | — |
| 226 | Vietnamese Spring Rolls | Vietnam | wikipedia | — | **P3** | — |
| 227 | Grilled Sea Bream | Mediterranean | wikipedia | — | **P3** | — |
| 229 | Roast Chicken Diavola | Italy | wikipedia | — | **P3** | — |
