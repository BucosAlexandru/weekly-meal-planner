...
|---|---|---|---|---|
| **1. Local image override** | 106 | Curated `<img>` from `public/images/<slug>.{webp,jpg}` | curated URL | ✓ same-origin asset, always reaches |
...
Total recipes: 264. Buckets 3 + 4 = **0 recipes that
...
| With local override (`public/images/<slug>.{jpg,webp}`) | 125 |
| SSR renders emoji (buckets 3 + 4) | 0 |
| SSR renders `<img>` (buckets 1 + 2) | 232 |
| Flagship recipes | 20 |
