...
|---|---|---|---|---|
| **1. Local image override** | 54 | Curated `<img>` from `public/images/<slug>.{webp,jpg}` | curated URL | ✓ same-origin asset, always reaches |
...
| With local override (`public/images/<slug>.{jpg,webp}`) | 54 |
