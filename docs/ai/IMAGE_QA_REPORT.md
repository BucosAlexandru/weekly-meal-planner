...
| **2. Mapped external image** | 159 | Spoonacular/Wikipedia `<img>` from `recipe-images.js` | mapped URL | mostly (URL liveness not asserted from sandbox) |
...
| **4. Fallback emoji** | 5 | Emoji 🍽️ in SSR, nothing else | **cover2.jpg ❌** | ✓ user sees emoji |

Total recipes: 204. Buckets 3 + 4 = **5 recipes that
...
## Bucket 4 — Fallback emoji (SSR emoji, **no URL anywhere** — 5 recipes)
...
|---|---|
| Total recipes | 204 |
| With external mapping in recipe-images.js | 178 |
| With local override (`public/images/<slug>.{jpg,webp}`) | 40 |
| SSR renders emoji (buckets 3 + 4) | 5 |
| SSR renders `<img>` (buckets 1 + 2) | 199 |
| Flagship recipes | 20 |
...
| 194 | Avgolemono | Greece | wikipedia | — | **P3** | — |
| 195 | Gyros | Greece | wikipedia | — | **P3** | — |
| 196 | Pastitsio | Greece | wikipedia | — | **P3** | — |
| 197 | Dolmades | Greece | wikipedia | — | **P3** | — |
| 198 | Galaktoboureko | Greece | wikipedia | — | **P3** | — |
...
| 204 | Butter Chicken (Murgh Makhani) | India | wikipedia | — | **P3** | — |
| 205 | Hyderabadi Lamb Biryani | India | wikipedia | — | **P3** | — |
| 206 | Palak Paneer | India | wikipedia | — | **P3** | — |
| 207 | Rogan Josh | India | wikipedia | — | **P3** | — |
| 208 | Samosa | India | wikipedia | — | **P3** | — |
