...
${plan.isBudget ? '<style>/* Budget plan only: auto-zoom the meal photo on hover (these recipes have no detail page). */.plan-meal-thumb{position:relative;transition:transform .18s ease,box-shadow .18s ease,border-radius .18s ease}.plan-meal-thumb:hover{transform:scale(3.4);z-index:60;border-radius:8px;box-shadow:0 10px 34px rgba(0,0,0,.45)}</style>' : ''}
