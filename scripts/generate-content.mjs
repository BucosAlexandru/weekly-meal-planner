...
const PRICING_COPY = {
  ro: {
    ...
    metaDesc:  'Compară planurile Gratuit și Premium. PDF-uri nelimitate, {{RECIPE_COUNT}} rețete din 49 țări, meniu cu buget — doar €3/lună.',
    ...
    freeFeats: ['✅ Planificator 7 zile','✅ Listă de cumpărături automată','✅ {{RECIPE_COUNT}} rețete din 49 țări','✅ 14 limbi','✅ Previzualizare gratuită — 2 zile din 7','✗ PDF complet 7 zile','✗ Meniu cu buget săptămânal'],
    premFeats: ['✅ Tot ce e în Gratuit, plus:','✅ PDF complet 7 zile','✅ Meniu cu buget săptămânal','✅ {{RECIPE_COUNT}} rețete din 49 țări','✅ Rețete noi adăugate regulat','✅ Acces nelimitat, oricând','✅ Anulezi oricând — fără angajament'],
    ...
    faq: [
      ...
      ['Ce adaugă Premium?','Un PDF cu întregul plan de 7 zile, meniu cu buget săptămânal, acces la toate cele {{RECIPE_COUNT}} rețete din 49 țări și rețete noi adăugate regulat — toate nelimitate.'],
  ...
  en: {
    ...
    metaDesc:  'Compare Free and Premium plans. Unlimited PDFs, {{RECIPE_COUNT}} recipes from 49 countries, weekly budget menu — just €3/month.',
    ...
    freeFeats: ['✅ 7-day meal planner','✅ Auto shopping list','✅ {{RECIPE_COUNT}} recipes from 49 countries','✅ 14 languages','✅ Free preview — 2 of 7 days','✗ Full 7-day PDF download','✗ Weekly budget menu'],
    premFeats: ['✅ Everything in Free, plus:','✅ Full 7-day PDF download','✅ Weekly budget menu','✅ {{RECIPE_COUNT}} recipes from 49 countries','✅ New recipes added regularly','✅ Unlimited access, anytime','✅ Cancel anytime — no commitment'],
    ...
    faq: [
      ...
      ['What does Premium add?','A single PDF with your entire 7-day plan, a weekly budget menu, access to all {{RECIPE_COUNT}} recipes from 49 countries, and new recipes added regularly — all unlimited.'],
  ...
  es: {
    ...
    metaDesc:  'Compara los planes Gratis y Premium. PDFs ilimitados, {{RECIPE_COUNT}} recetas de 49 países, menú con presupuesto — solo €3/mes.',
    ...
    freeFeats: ['✅ Planificador de 7 días','✅ Lista de compras automática','✅ {{RECIPE_COUNT}} recetas de 49 países','✅ 14 idiomas','✅ Vista previa gratuita — 2 de 7 días','✗ PDF completo de 7 días','✗ Menú semanal con presupuesto'],
    premFeats: ['✅ Todo en Gratis, más:','✅ PDF completo de 7 días','✅ Menú semanal con presupuesto','✅ {{RECIPE_COUNT}} recetas de 49 países','✅ Nuevas recetas añadidas regularmente','✅ Acceso ilimitado, en cualquier momento','✅ Cancela cuando quieras'],
    ...
    faq: [
      ...
      ['¿Qué agrega Premium?','Un PDF con tu plan completo de 7 días, menú semanal con presupuesto, acceso a las {{RECIPE_COUNT}} recetas de 49 países y nuevas recetas regularmente — todo ilimitado.'],
  ...
  fr: {
    ...
    metaDesc:  'Comparez les offres Gratuit et Premium. PDFs illimités, {{RECIPE_COUNT}} recettes de 49 pays, menu budgétaire — seulement €3/mois.',
    ...
    freeFeats: ['✅ Planificateur 7 jours','✅ Liste de courses automatique','✅ {{RECIPE_COUNT}} recettes de 49 pays','✅ 14 langues','✅ Aperçu gratuit — 2 jours sur 7','✗ PDF complet 7 jours','✗ Menu hebdomadaire budgétaire'],
    premFeats: ['✅ Tout ce qui est dans Gratuit, plus :','✅ PDF complet 7 jours','✅ Menu hebdomadaire budgétaire','✅ {{RECIPE_COUNT}} recettes de 49 pays','✅ Nouvelles recettes ajoutées régulièrement','✅ Accès illimité, à tout moment','✅ Annulez quand vous voulez'],
    ...
    faq: [
      ...
      ['Que ajoute Premium ?',"Un PDF avec votre plan complet de 7 jours, un menu budgétaire, accès aux {{RECIPE_COUNT}} recettes de 49 pays et nouvelles recettes ajoutées régulièrement — tout illimité."],
  ...
  de: {
    ...
    metaDesc:  'Kostenlose und Premium-Pläne vergleichen. Unbegrenzte PDFs, {{RECIPE_COUNT}} Rezepte aus 49 Ländern, Wochenbudget-Menü — nur €3/Monat.',
    ...
    freeFeats: ['✅ 7-Tage-Mahlzeitenplaner','✅ Automatische Einkaufsliste','✅ {{RECIPE_COUNT}} Rezepte aus 49 Ländern','✅ 14 Sprachen','✅ Kostenlose Vorschau — 2 von 7 Tagen','✗ Vollständiges 7-Tage-PDF','✗ Wöchentliches Budget-Menü'],
    premFeats: ['✅ Alles aus Kostenlos, plus:','✅ Vollständiges 7-Tage-PDF','✅ Wöchentliches Budget-Menü','✅ {{RECIPE_COUNT}} Rezepte aus 49 Ländern','✅ Regelmäßig neue Rezepte','✅ Unbegrenzter Zugang, jederzeit','✅ Jederzeit kündbar — keine Bindung'],
    ...
    faq: [
      ...
      ['Was bietet Premium zusätzlich?','Ein vollständiges 7-Tage-PDF, ein Wochenbudget-Menü, Zugang zu allen {{RECIPE_COUNT}} Rezepten aus 49 Ländern und regelmäßig neue Rezepte — alles unbegrenzt.'],
  ...
  pt: {
    ...
    metaDesc:  'Compare os planos Gratuito e Premium. PDFs ilimitados, {{RECIPE_COUNT}} receitas de 49 países, menu com orçamento — apenas €3/mês.',
    ...
    freeFeats: ['✅ Planejador de 7 dias','✅ Lista de compras automática','✅ {{RECIPE_COUNT}} receitas de 49 países','✅ 14 idiomas','✅ Pré-visualização gratuita — 2 de 7 dias','✗ PDF completo de 7 dias','✗ Menu semanal com orçamento'],
    premFeats: ['✅ Tudo no Gratuito, mais:','✅ PDF completo de 7 dias','✅ Menu semanal com orçamento','✅ {{RECIPE_COUNT}} receitas de 49 países','✅ Novas receitas regularmente','✅ Acesso ilimitado, a qualquer momento','✅ Cancele quando quiser'],
    ...
    faq: [
      ...
      ['O que o Premium adiciona?','Um PDF com o seu plano completo de 7 dias, menu semanal com orçamento, acesso a todas as {{RECIPE_COUNT}} receitas de 49 países e novas receitas regularmente — tudo ilimitado.'],
  ...
  ru: {
    ...
    metaDesc:  'Сравните бесплатный и премиум-планы. Неограниченные PDF, {{RECIPE_COUNT}} рецептов из 49 стран, недельное меню — всего €3/мес.',
    ...
    freeFeats: ['✅ Планировщик на 7 дней','✅ Автоматический список покупок','✅ {{RECIPE_COUNT}} рецептов из 49 стран','✅ 14 языков','✅ Бесплатный просмотр — 2 из 7 дней','✗ Полный PDF на 7 дней','✗ Недельное бюджетное меню'],
    premFeats: ['✅ Всё из Бесплатного, плюс:','✅ Полный PDF на 7 дней','✅ Недельное бюджетное меню','✅ {{RECIPE_COUNT}} рецептов из 49 стран','✅ Новые рецепты регулярно','✅ Неограниченный доступ в любое время','✅ Отмена в любой момент'],
    ...
    faq: [
      ...
      ['Что добавляет Premium?','PDF со всем 7-дневным планом, недельное бюджетное меню, доступ ко всем {{RECIPE_COUNT}} рецептам из 49 стран и новые рецепты регулярно — всё без ограничений.'],
  ...
  ar: {
    ...
    metaDesc:  'قارن بين الخطة المجانية وبريميوم. PDFs غير محدودة، {{RECIPE_COUNT}} وصفة من 49 دولة، قائمة طعام أسبوعية — فقط €3/شهر.',
    ...
    freeFeats: ['✅ مخطط وجبات لمدة 7 أيام','✅ قائمة تسوق تلقائية','✅ {{RECIPE_COUNT}} وصفة من 49 دولة','✅ 14 لغة','✅ معاينة مجانية — يومان من أصل 7','✗ ملف PDF كامل لمدة 7 أيام','✗ قائمة طعام أسبوعية بالميزانية'],
    premFeats: ['✅ كل ما في المجاني، بالإضافة إلى:','✅ ملف PDF كامل لمدة 7 أيام','✅ قائمة طعام أسبوعية بالميزانية','✅ {{RECIPE_COUNT}} وصفة من 49 دولة','✅ وصفات جديدة بانتظام','✅ وصول غير محدود في أي وقت','✅ إلغاء في أي وقت'],
  ...
  zh: {
    ...
    metaDesc:  '比较免费版和高级版。无限PDF下载、来自 49 国家的 {{RECIPE_COUNT}} 道食谱、每周预算菜单 — 仅需€3/月。',
    title:     '简单透明的定价',
    ...
    alreadyLabel:    '已有订阅？',
    alreadyActivate: '激活 →',
    freeFeats: ['✅ 7天饮食计划器','✅ 自动购物清单','✅ {{RECIPE_COUNT}}道来自49国家的食谱','✅ 14种语言','✅ 免费预览 — 7天中的2天','✗ 完整7天PDF下载','✗ 每周预算菜单'],
    premFeats: ['✅ 免费版所有功能，另加：','✅ 完整7天PDF下载','✅ 每周预算菜单','✅ 来自 49 国家的 {{RECIPE_COUNT}} 道食谱','✅ 定期添加新食谱','✅ 随时无限访问','✅ 随时取消，无承诺'],
    faqTitle:  '常见问题',
    faq: [
      ['免费版包含什么？','完整访问7天计划器、自动购物清单、14种语言的{{RECIPE_COUNT}}道食谱以及免费PDF预览（7天中的2天）。'],
      ['高级版增加了什么？','包含您完整7天计划的PDF、每周预算菜单、来自49国家的{{RECIPE_COUNT}}道食谱以及定期添加的新食谱 — 全部无限次使用。'],
  ...
  hi: {
    ...
    metaDesc:  'निःशुल्क और प्रीमियम योजनाओं की तुलना करें। असीमित PDF, 49 देशों से {{RECIPE_COUNT}} रेसिपी, साप्ताहिक बजट मेनू — केवल €3/माह।',
    ...
    freeFeats: ['✅ 7-दिन का मील प्लानर','✅ स्वचालित खरीदारी सूची','✅ 49 देशों से {{RECIPE_COUNT}} रेसिपी','✅ 14 भाषाएं','✅ मुफ्त पूर्वावलोकन — 7 में से 2 दिन','✗ 7-दिन का पूर्ण PDF डाउनलोड','✗ साप्ताहिक बजट मेनू'],
    premFeats: ['✅ निःशुल्क में सब कुछ, साथ ही:','✅ 7-दिन का पूर्ण PDF डाउनलोड','✅ साप्ताहिक बजट मेनू','✅ 49 देशों से {{RECIPE_COUNT}} रेसिपी','✅ नियमित रूप से नई रेसिपी','✅ कभी भी असीमित पहुंच','✅ कभी भी रद्द करें'],
    ...
    faq: [
      ...
      ['प्रीमियम क्या जोड़ता है?','आपके 7-दिन के पूर्ण प्लान के साथ PDF, साप्ताहिक बजट मेनू, 49 देशों से सभी {{RECIPE_COUNT}} रेसिपी तक पहुँच और नियमित रूप से नई रेसिपी — सभी असीमित।'],
  ...
  tr: {
    ...
    metaDesc:  'Ücretsiz ve Premium planları karşılaştırın. Sınırsız PDF, 49 ülkeden {{RECIPE_COUNT}} tarif, haftalık bütçe menüsü — sadece €3/ay.',
    ...
    freeFeats: ['✅ 7 günlük yemek planlayıcı','✅ Otomatik alışveriş listesi','✅ 49 ülkeden {{RECIPE_COUNT}} tarif','✅ 14 dil','✅ Ücretsiz önizleme — 7 günden 2\'si','✗ 7 günlük tam PDF indirme','✗ Haftalık bütçe menüsü'],
    premFeats: ['✅ Ücretsiz\'deki her şey, artı:','✅ 7 günlük tam PDF indirme','✅ Haftalık bütçe menüsü','✅ 49 ülkeden {{RECIPE_COUNT}} tarif','✅ Düzenli olarak yeni tarifler','✅ İstediğiniz zaman sınırsız erişim','✅ İstediğiniz zaman iptal edin'],
    ...
    faq: [
      ...
      ['Premium ne ekler?','7 günlük tam planınızı içeren PDF, haftalık bütçe menüsü, 49 ülkeden {{RECIPE_COUNT}} tarife erişim ve düzenli olarak eklenen yeni tarifler — hepsi sınırsız.'],
  ...
  it: {
    ...
    metaDesc:  'Confronta i piani Gratuito e Premium. PDF illimitati, {{RECIPE_COUNT}} ricette da 49 paesi, menu settimanale con budget — solo €3/mese.',
    ...
    freeFeats: ['✅ Pianificatore 7 giorni','✅ Lista della spesa automatica','✅ {{RECIPE_COUNT}} ricette da 49 paesi','✅ 14 lingue','✅ Anteprima gratuita — 2 giorni su 7','✗ PDF completo 7 giorni','✗ Menu settimanale con budget'],
    premFeats: ['✅ Tutto nel Gratuito, più:','✅ PDF completo 7 giorni','✅ Menu settimanale con budget','✅ {{RECIPE_COUNT}} ricette da 49 paesi','✅ Nuove ricette aggiunte regolarmente','✅ Accesso illimitato, in qualsiasi momento','✅ Disdici quando vuoi'],
    ...
    faq: [
      ...
      ['Cosa aggiunge Premium?','Un PDF con il tuo piano completo di 7 giorni, menu settimanale con budget, accesso a tutte le {{RECIPE_COUNT}} ricette da 49 paesi e nuove ricette aggiunte regolarmente — tutto illimitato.'],
  ...
  ko: {
    ...
    metaDesc:  '무료 및 프리미엄 플랜을 비교하세요. 무제한 PDF, 49 국가의 {{RECIPE_COUNT}}개 레시피, 주간 예산 메뉴 — 월 €3만으로.',
    title:     '간단하고 투명한 요금제',
    ...
    premFeats: ['✅ 무료의 모든 것, 추가로:','✅ 7일 전체 PDF 다운로드','✅ 주간 예산 메뉴','✅ 49 국가의 {{RECIPE_COUNT}}개 레시피','✅ 정기적으로 새 레시피 추가','✅ 언제든지 무제한 액세스','✅ 언제든지 취소 가능'],
    faqTitle:  '자주 묻는 질문',
    faq: [
      ['무료 플랜에는 무엇이 포함되나요?','7일 플래너, 자동 쇼핑 목록, 14개 언어로 된 {{RECIPE_COUNT}}가지 레시피, 무료 PDF 미리보기(7일 중 2일)에 대한 전체 액세스.'],
      ['프리미엄은 무엇을 추가하나요?','7일 전체 플랜이 담긴 PDF, 주간 예산 메뉴, 49 국가의 {{RECIPE_COUNT}}개 레시피 이용, 정기적으로 추가되는 새 레시피 — 모두 무제한.'],
...
const RECIPE_LANG = {
  ro: { dir:'/ro/retete',    indexTitle:'Rețete din Toată Lumea | Meal-Planner.ro',
        ...
        indexDesc: n=>`<p>De la mesele de familie la tradițiile transmise din generație în generație.</p><p>${n} rețete din 49 de bucătării, în 14 limbi.</p><p>Alege unde începe cina de azi.</p>`,
        indexKicker:'În Napoli, gnocchi se rulează.<br>La Tokyo, supa clocotește.<br>La Lyon, untul se rumenește.<br><strong>Toate patruzeci și nouă de bucătării sunt vii.</strong>',
  ...
  en: { dir:'/en/recipes',   indexTitle:`Recipes from Around the World | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>From family tables to traditions passed down through generations.</p><p>${n} recipes from 49 kitchens, in 14 languages.</p><p>Choose where dinner starts today.</p>`,
        indexKicker:'In Naples, gnocchi are folding.<br>In Tokyo, broth is steaming.<br>In Lyon, butter is browning.<br><strong>All forty-nine kitchens are alive right now.</strong>',
  ...
  es: { dir:'/es/recetas',   indexTitle:`Recetas del Mundo | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>De las mesas familiares a las tradiciones que pasan de generación en generación.</p><p>${n} recetas de 49 cocinas, en 14 idiomas.</p><p>Elige dónde empieza la cena de hoy.</p>`,
        indexKicker:'En Nápoles, alguien enrolla gnocchi.<br>En Tokio, un caldo hierve.<br>En Lyon, la mantequilla se dora.<br><strong>Cuarenta y nueve cocinas están vivas ahora mismo.</strong>',
  ...
  fr: { dir:'/fr/recettes',  indexTitle:`Recettes du Monde | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>Des tables familiales aux traditions transmises de génération en génération.</p><p>${n} recettes de 49 cuisines, en 14 langues.</p><p>Choisissez où commence le dîner d'aujourd'hui.</p>`,
        indexKicker:'À Naples, on roule des gnocchis.<br>À Tokyo, un bouillon mijote.<br>À Lyon, le beurre rissole.<br><strong>Quarante-neuf cuisines sont vivantes en ce moment.</strong>',
  ...
  de: { dir:'/de/rezepte',   indexTitle:`Rezepte aus aller Welt | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>Vom Familientisch zu Traditionen, die über Generationen weitergegeben werden.</p><p>${n} Rezepte aus 49 Küchen, in 14 Sprachen.</p><p>Wähle, wo das heutige Abendessen beginnt.</p>`,
        indexKicker:'In Neapel rollen gerade Gnocchi.<br>In Tokio köchelt eine Brühe.<br>In Lyon bräunt Butter.<br><strong>Neunundvierzig Küchen sind jetzt lebendig.</strong>',
  ...
  pt: { dir:'/pt/receitas',  indexTitle:`Receitas do Mundo | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>Das mesas de família às tradições transmitidas de geração em geração.</p><p>${n} receitas de 49 cozinhas, em 14 idiomas.</p><p>Escolha onde começa o jantar de hoje.</p>`,
        indexKicker:'Em Nápoles, alguém enrola nhoques.<br>Em Tóquio, um caldo ferve.<br>Em Lyon, a manteiga doura.<br><strong>Quarenta e nove cozinhas estão vivas neste instante.</strong>',
  ...
  ru: { dir:'/ru/retsepty',  indexTitle:`Рецепты со всего мира | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>От семейных столов до традиций, передаваемых из поколения в поколение.</p><p>${n} рецептов из 49 кухонь, на 14 языках.</p><p>Выберите, где начнётся сегодняшний ужин.</p>`,
        indexKicker:'В Неаполе раскатывают ньокки.<br>В Токио кипит бульон.<br>В Лионе румянится масло.<br><strong>Сорок девять кухонь живы прямо сейчас.</strong>',
  ...
  ar: { dir:'/ar/wasafat',   indexTitle:`وصفات من حول العالم | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>من موائد العائلة إلى التقاليد المتوارثة جيلاً بعد جيل.</p><p>${n} وصفة من 49 مطبخًا، بـ 14 لغة.</p><p>اختر من أين يبدأ عشاء اليوم.</p>`,
        indexKicker:'في نابولي، يُلفّ النوكي.<br>في طوكيو، يغلي المرق.<br>في ليون، تتحمر الزبدة.<br><strong>تسعة وأربعون مطبخًا على قيد الحياة الآن.</strong>',
  ...
  zh: { dir:'/zh/shipu',     indexTitle:`世界各地食谱 | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>从家庭餐桌到代代相传的传统。</p><p>来自49个厨房的${n}道食谱，14种语言。</p><p>选择今天晚餐从哪里开始。</p>`,
        indexKicker:'那不勒斯，有人在卷意大利团子。<br>东京，高汤正在沸腾。<br>里昂，黄油在焦化。<br><strong>此刻，四十九个厨房都在运转。</strong>',
  ...
  ja: { dir:'/ja/reshipi',   indexTitle:`世界の料理レシピ | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>家族の食卓から、世代を超えて受け継がれる伝統まで。</p><p>49の厨房から${n}のレシピ、14言語で。</p><p>今日の食事をどこから始めるか選びましょう。</p>`,
        indexKicker:'ナポリでは、ニョッキが丸まっている。<br>東京では、出汁が沸いている。<br>リヨンでは、バターが色づいている。<br><strong>四十九の厨房が今、生きている。</strong>',
  ...
  hi: { dir:'/hi/recipes',   indexTitle:`दुनिया भर की रेसिपी | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>परिवार की मेज़ से लेकर पीढ़ी दर पीढ़ी चली आ रही परंपराओं तक।</p><p>49 रसोइयों की ${n} रेसिपी, 14 भाषाओं में।</p><p>आज का खाना कहां से शुरू होगा, चुनें।</p>`,
        indexKicker:'नेपल्स में, कोई ग्नोकी बेल रहा है।<br>टोक्यो में, शोरबा उबल रहा है।<br>ल्यों में, मक्खन सुनहरा हो रहा है।<br><strong>उनचास रसोइयाँ अभी ज़िंदा हैं।</strong>',
  ...
  tr: { dir:'/tr/tarifler',  indexTitle:`Dünyadan Tarifler | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>Aile sofralarından nesilden nesle aktarılan geleneklere.</p><p>49 mutfaktan ${n} tarif, 14 dilde.</p><p>Bugünkü akşam yemeğinin nereden başlayacağını seç.</p>`,
        indexKicker:"Napoli'de biri gnocchi yuvarlıyor.<br>Tokyo'da et suyu kaynıyor.<br>Lyon'da tereyağı kavruluyor.<br><strong>Kırk dokuz mutfak şu an canlı.</strong>",
  ...
  it: { dir:'/it/ricette',   indexTitle:`Ricette dal Mondo | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>Dalle tavole di famiglia alle tradizioni tramandate di generazione in generazione.</p><p>${n} ricette da 49 cucine, in 14 lingue.</p><p>Scegli dove inizia la cena di oggi.</p>`,
        indexKicker:'A Napoli, qualcuno rotola gli gnocchi.<br>A Tokyo, un brodo sobbolle.<br>A Lione, il burro si dora.<br><strong>Quarantanove cucine sono vive in questo istante.</strong>',
  ...
  ko: { dir:'/ko/recipes',   indexTitle:`세계 요리 레시피 | Meal-Planner.ro`,
        ...
        indexDesc: n=>`<p>가족의 식탁에서 대대로 이어진 전통까지.</p><p>49개 주방의 ${n}가지 레시피, 14개 언어로.</p><p>오늘의 저녁이 어디서 시작될지 선택하세요.</p>`,
        indexKicker:'나폴리에서 누군가 뇨키를 말고 있다.<br>도쿄에서 육수가 끓고 있다.<br>리옹에서 버터가 노릇해진다.<br><strong>마흔아홉 개의 주방이 지금 살아 있다.</strong>',
