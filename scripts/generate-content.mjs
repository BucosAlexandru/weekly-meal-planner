...
const PRICING_COPY = {
  ro: {
    ...
    freeFeats: ['✅ Planificator 7 zile','✅ Listă de cumpărături automată','✅ 175 rețete din 70+ țări','✅ 14 limbi','✅ 1 PDF complet/zi','✗ PDF complet 7 zile','✗ Meniu cu buget săptămânal','✗ Asistent AI rețete','✗ Asistent AI planificare mese'],
  ...
  en: {
    ...
    freeFeats: ['✅ 7-day meal planner','✅ Auto shopping list','✅ 175 recipes from 70+ countries','✅ 14 languages','✅ 1 full PDF/day','✗ Full 7-day PDF download','✗ Weekly budget menu','✗ AI recipe assistant','✗ AI meal planning assistant'],
  ...
  es: {
    ...
    freeFeats: ['✅ Planificador de 7 días','✅ Lista de compras automática','✅ 175 recetas de 70+ países','✅ 14 idiomas','✅ 1 PDF completo/día','✗ PDF completo de 7 días','✗ Menú semanal con presupuesto','✗ Asistente de recetas IA','✗ Asistente IA planificación'],
  ...
  fr: {
    ...
    freeFeats: ['✅ Planificateur 7 jours','✅ Liste de courses automatique','✅ 175 recettes de 70+ pays','✅ 14 langues','✅ 1 PDF complet/jour','✗ PDF complet 7 jours','✗ Menu hebdomadaire budgétaire','✗ Assistant recettes IA','✗ Assistant IA planification'],
  ...
  de: {
    ...
    freeFeats: ['✅ 7-Tage-Mahlzeitenplaner','✅ Automatische Einkaufsliste','✅ 175 Rezepte aus 70+ Ländern','✅ 14 Sprachen','✅ 1 vollständiges PDF/Tag','✗ Vollständiges 7-Tage-PDF','✗ Wöchentliches Budget-Menü','✗ KI-Rezept-Assistent','✗ KI-Mahlzeiten-Assistent'],
  ...
  pt: {
    ...
    freeFeats: ['✅ Planejador de 7 dias','✅ Lista de compras automática','✅ 175 receitas de 70+ países','✅ 14 idiomas','✅ 1 PDF completo/dia','✗ PDF completo de 7 dias','✗ Menu semanal com orçamento','✗ Assistente de receitas IA','✗ Assistente IA planeamento'],
  ...
  ru: {
    ...
    freeFeats: ['✅ Планировщик на 7 дней','✅ Автоматический список покупок','✅ 175 рецептов из 70+ стран','✅ 14 языков','✅ 1 полный PDF/день','✗ Полный PDF на 7 дней','✗ Недельное бюджетное меню','✗ ИИ-помощник по рецептам','✗ ИИ-помощник по планированию'],
  ...
  ar: {
    ...
    freeFeats: ['✅ مخطط وجبات لمدة 7 أيام','✅ قائمة تسوق تلقائية','✅ 175 وصفة من 70+ دولة','✅ 14 لغة','✅ ملف PDF واحد كامل/يوم','✗ ملف PDF كامل لمدة 7 أيام','✗ قائمة طعام أسبوعية بالميزانية','✗ مساعد وصفات بالذكاء الاصطناعي','✗ مساعد الذكاء الاصطناعي للتخطيط'],
  ...
  zh: {
    ...
    alreadyLabel:    '已有订阅？',
    alreadyActivate: '激活 →',
    freeFeats: ['✅ 7天饮食计划器','✅ 自动购物清单','✅ 175道来自70+国家的食谱','✅ 14种语言','✅ 每天1个完整PDF','✗ 完整7天PDF下载','✗ 每周预算菜单','✗ AI食谱助手','✗ AI膳食规划助手'],
  ...
  ja: {
    ...
    alreadyActivate: '有効化 →',
    freeFeats: ['✅ 7日間ミールプランナー','✅ 自動買い物リスト','✅ 70カ国以上の175レシピ','✅ 14言語','✅ 1日1つの完全PDF','✗ 7日間完全PDFダウンロード','✗ 週次予算メニュー','✗ AIレシピアシスタント','✗ AIミールプランアシスタント'],
  ...
  hi: {
    ...
    freeFeats: ['✅ 7-दिन का मील प्लानर','✅ स्वचालित खरीदारी सूची','✅ 70+ देशों से 175 रेसिपी','✅ 14 भाषाएं','✅ 1 पूर्ण PDF/दिन','✗ 7-दिन का पूर्ण PDF डाउनलोड','✗ साप्ताहिक बजट मेनू','✗ AI रेसिपी सहायक','✗ AI भोजन योजना सहायक'],
  ...
  tr: {
    ...
    freeFeats: ['✅ 7 günlük yemek planlayıcı','✅ Otomatik alışveriş listesi','✅ 70+ ülkeden 175 tarif','✅ 14 dil','✅ Günde 1 tam PDF','✗ 7 günlük tam PDF indirme','✗ Haftalık bütçe menüsü','✗ AI tarif asistanı','✗ AI yemek planlama asistanı'],
  ...
  it: {
    ...
    freeFeats: ['✅ Pianificatore 7 giorni','✅ Lista della spesa automatica','✅ 175 ricette da 70+ paesi','✅ 14 lingue','✅ 1 PDF completo/giorno','✗ PDF completo 7 giorni','✗ Menu settimanale con budget','✗ Assistente ricette IA','✗ Assistente IA pianificazione'],
  ...
  ko: {
    ...
    alreadyActivate: '활성화 →',
    freeFeats: ['✅ 7일 식단 플래너','✅ 자동 쇼핑 목록','✅ 70개국 이상 175가지 레시피','✅ 14개 언어','✅ 하루 1개 전체 PDF','✗ 7일 전체 PDF 다운로드','✗ 주간 예산 메뉴','✗ AI 레시피 도우미','✗ AI 식단 계획 도우미'],
