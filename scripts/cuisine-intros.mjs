...
export const CUISINE_INTRO = {
  ...
  'Iran': {
    ...
    hi: "फारसी रसोई धैर्य के साथ स्वाद की परतें बनाती है — अखरोट और अनार से गाढ़ी फेसेनजान, पकी जड़ी-बूटियों से हरी घोरमे सब ज़ी। केसर, सूखा नींबू और चावल की तहदिग से मेज़ पूरी होती है।",
