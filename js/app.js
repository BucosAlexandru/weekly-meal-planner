...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    ...
    fr: {
      ...
      maxed:      "Nombre maximum de PDF gratuits atteint.<br>Payer pentru download nelimitat!",
    ...
    ru: {
      ...
      maxed:      "Достигнут лимит бесплатных PDF.<br>Оплатите pentru descărcari nelimitate!",
    ...
    zh: {
      ...
      "btn.pay":  "支付并下载",
      processing: "正在处理付款...",
      maxed:      "已达到免费PDF最大数量。<br>支付 pentru descărcări nelimitate!",
    ...
    ja: {
      ...
      "btn.pay":  "支払ってダウンロード",
      processing: "お支払い処理中...",
      maxed:      "無料PDFの最大数に達しました。<br>支払 pentru nelimitat!",
    ...
    pt: {
      ...
      maxed:      "Atingiu limita maxima de free PDFs.<br>Paga pentru unlimited downloads!",
    ...
    de: {
      ...
      maxed:      "Maximale Anzahl kostenloser PDFs erreicht.<br>Zahlen Sie pentru descărcări nelimitate!"
    },
    ar: {
      ...
      maxed:      "لقد وصلت للحد الأقصى de PDF gratuite.<br>ادفع pentru nelimitat!",
      placeholderL:"مثال: بطاطس، بصل",
      placeholderD:"مثال: دجاج، أرز"
    },
    hi: {
      weekdays:   ['सोमवार','मंगलुवार','बुधवार','गुरुवार','शुक्रवार','शनिवार','रविबार'],
      ...
      maxed:      "आपने मुफ्त PDF की सीमा पूरी कर ली है।<br>पेमेन्ट pentru unlimited!",
