const i18n = {
  ro: {
    ...
    msg: {
      ...
      server_error: "Eroare server. Încercați din nou.",
      invalid: "Nu există acces valid pentru acest email.",
      not_found: "Nu există acces pentru acest email. Plătește întâi sau verifică adresa.",
      valid: "✅ Ai acces! Poți descărca PDF-ul nelimitat:"
    },
    "btn.generate": "Generează PDF",
    "export.title": "Descarcă PDF",
    "export.sub": "Planul tău, rețete și lista de cumpărături",
    ...
    "btn.switchAccount": "Schimbă contul",
    ...
    "pw.lunch": "Prânz",
    "pw.dinner": "Cină",
    "pw.ovDays": "Zile planificate",
    "pw.ovTime": "Timp mediu",
    "pw.ovCost": "Cost estimat",
    "pw.ovCuisines": "Bucătării",
    "col.origin": "Țara",
    "col.ingredients": "Ingrediente",
    "howIsMade": "Cum se face:",
    shoppingList: "Lista de cumpărături",
    "shopping.teaser.desc": "Organizată automat pe categorii și gata de cumpărături în PDF.",
    "shopping.empty": "Adaugă mese pentru a genera lista",
    maxed: "Ai atins limita maximă de PDF-uri gratuite.<br>Plătește pentru a debloca descărcarea nelimitată!",
    "pdf.free.label": "Previzualizare gratuită — 2 zile din 7",
    "pdf.locked.title": "🔒 Zilele 3 – 7 sunt disponibile cu abonamentul Premium",
    "pdf.locked.sub": "Deblochează planul complet pentru toată săptămâna, inclusiv rețete, ingrediente și lista de cumpărături.",
    "pdf.locked.cta": "Obține acces complet →",
    "mode.meal": "O masă", "mode.day": "O zi", "mode.week": "O săptămână",
    "mode.heading.meal": "Alege o masă", "mode.heading.day": "Planul de azi", "mode.heading.week": "Planul săptămânii",
    "mode.btn.meal": "✨ Surprinde-mă!", "mode.btn.day": "Generează ziua", "mode.btn.week": "Generează săptămâna",
    "mode.col.meal": "Masă sugerată",
    "today": "Azi",
    ...
    "perWeek": "săptămână · 2 persoane",
    "estWeeklyCost": "Cost estimat săptămână",
    "hero.badge": "✨ Gratuit · Fără cont · 14 limbi",
    "hero.sub": "Planifică mesele pentru 7 zile, generează lista de cumpărături automat și descarcă PDF — tot gratuit.",
    "hero.social": "Folosit în 14 limbi în toată lumea 🌍",
    "hero.cta": "🥗 Creează Planul Meu Gratuit",
    "mealsFound": "mese găsite",
  ...
  en: {
    ...
    msg: {
      ...
      invalid: "No valid access found for this email.",
      not_found: "No access found. Please pay first or check the email.",
      valid: "✅ Access granted! You can download unlimited PDFs:"
    },
    "btn.generate": "Generate PDF",
    "export.title": "Download PDF",
    "export.sub": "Your plan, recipes & shopping list",
    ...
    "pw.lunch": "Lunch",
    "pw.dinner": "Dinner",
    "pw.ovDays": "Days planned",
    "pw.ovTime": "Avg. time",
    "pw.ovCost": "Est. cost",
    "pw.ovCuisines": "Cuisines",
    "col.origin": "Country",
    "col.ingredients": "Ingredients",
    "howIsMade": "How it's made:",
    shoppingList: "Shopping List",
    "shopping.teaser.desc": "Automatically organized by category and ready to shop in the PDF.",
    "shopping.empty": "Add meals to generate your shopping list",
    maxed: "You have reached the maximum number of free PDFs.<br>Pay to unlock unlimited downloads!",
    "pdf.free.label": "Free preview — 2 of 7 days",
    "pdf.locked.title": "🔒 Days 3 – 7 are available with Premium",
    "pdf.locked.sub": "Unlock the full 7-day plan with recipes, ingredients and shopping list.",
    "pdf.locked.cta": "Get full access →",
    "mode.meal": "One Meal", "mode.day": "One Day", "mode.week": "One Week",
    "mode.heading.meal": "Pick a meal", "mode.heading.day": "Today's plan", "mode.heading.week": "Weekly plan",
    "mode.btn.meal": "✨ Surprise me!", "mode.btn.day": "Generate day", "mode.btn.week": "Generate week",
    "mode.col.meal": "Suggested meal",
    "today": "Today",
    ...
    "perWeek": "week · 2 people",
    "estWeeklyCost": "Estimated weekly cost",
    "hero.badge": "✨ Free · No account · 14 languages",
    "hero.sub": "Plan meals for 7 days, auto-generate your shopping list, and download a PDF — completely free.",
    "hero.social": "Used in 14 languages worldwide 🌍",
    "hero.cta": "🥗 Create My Free Meal Plan",
  ...
  es: {
    ...
    msg: {
      ...
      empty: "¡Por favor ingresa tu email!",
      server_error: "Error del servidor. Inténtalo de nuevo.",
      invalid: "No se encontró acceso válido para este email.",
      not_found: "No se encontró acceso. Por favor paga primero o revisa el email.",
      valid: "✅ ¡Acceso concedido! Ahora puedes descargar PDFs ilimitados:"
    },
    "btn.generate": "Generar PDF",
    "export.title": "Descargar PDF",
    "export.sub": "Tu plan, recetas y lista de compras",
    ...
    "btn.switchAccount": "Cambiar cuenta",
    ...
    "pw.lunch": "Almuerzo",
    "pw.dinner": "Cena",
    "pw.ovDays": "Días planificados",
    "pw.ovTime": "Tiempo medio",
    "pw.ovCost": "Coste estimado",
    "pw.ovCuisines": "Cocinas",
    "col.origin": "País",
    "col.ingredients": "Ingredientes",
    "howIsMade": "Cómo se hace:",
    shoppingList: "Lista de Compras",
    "shopping.teaser.desc": "Organizada automáticamente por categorías y lista para comprar en el PDF.",
    "shopping.empty": "Añade comidas para generar tu lista",
    maxed: "¡Has alcanzado el máximo de PDFs gratuitos!<br>¡Paga para descargas ilimitadas!",
    "pdf.free.label": "Vista previa gratuita — 2 de 7 días",
    "pdf.locked.title": "🔒 Los días 3 – 7 están disponibles con Premium",
    "pdf.locked.sub": "Desbloquea el plan completo de 7 días con recetas, ingredientes y lista de compras.",
    "pdf.locked.cta": "Obtener acceso completo →",
    "mode.meal": "Una comida", "mode.day": "Un día", "mode.week": "Una semana",
    "mode.heading.meal": "Elige una comida", "mode.heading.day": "Plan de hoy", "mode.heading.week": "Plan semanal",
    "mode.btn.meal": "✨ ¡Sorpréndeme!", "mode.btn.day": "Generar día", "mode.btn.week": "Generar semana",
    "mode.col.meal": "Comida sugerida", "today": "Hoy",
    ...
    "perWeek": "semana · 2 personas",
    "estWeeklyCost": "Coste semanal estimado",
    ...
    "mealsFound": "comidas encontradas",
  ...
  fr: {
    ...
    msg: {
      ...
      invalid: "Aucun accès valide trouvé pour cet email.",
      not_found: "Aucun accès trouvé. Veuillez d'abord payer ou vérifier l'email.",
      valid: "✅ Accès accordé ! Vous pouvez désormais télécharger des PDF en illimité :"
    },
    "btn.generate": "Générer PDF",
    "export.title": "Télécharger PDF",
    "export.sub": "Votre plan, recettes et liste de courses",
    ...
    "btn.switchAccount": "Changer de compte",
    ...
    "pw.lunch": "Déjeuner",
    "pw.dinner": "Dîner",
    "pw.ovDays": "Jours planifiés",
    "pw.ovTime": "Temps moyen",
    "pw.ovCost": "Coût estimé",
    "pw.ovCuisines": "Cuisines",
    "col.origin": "Pays",
    "col.ingredients": "Ingrédients",
    "howIsMade": "Comment c'est fait :",
    shoppingList: "Liste de Courses",
    "shopping.teaser.desc": "Organisée automatiquement par catégories et prête pour les courses dans le PDF.",
    "shopping.empty": "Ajoutez des repas pour générer votre liste",
    maxed: "Vous avez atteint la limite de PDFs gratuits.<br>Payer pour débloquer les téléchargements illimités !",
    "pdf.free.label": "Aperçu gratuit — 2 jours sur 7",
    "pdf.locked.title": "🔒 Les jours 3 – 7 sont disponibles avec Premium",
    "pdf.locked.sub": "Débloquez le plan complet de 7 jours avec recettes, ingrédients et liste de courses.",
    "pdf.locked.cta": "Obtenir l'accès complet →",
    "mode.meal": "Un repas", "mode.day": "Un jour", "mode.week": "Une semaine",
    "mode.heading.meal": "Choisir un repas", "mode.heading.day": "Plan du jour", "mode.heading.week": "Plan de la semaine",
    "mode.btn.meal": "✨ Surprends-moi !", "mode.btn.day": "Générer la journée", "mode.btn.week": "Générer la semaine",
    "mode.col.meal": "Repas suggéré", "today": "Aujourd'hui",
    ...
    "perWeek": "semaine · 2 personnes",
    "estWeeklyCost": "Coût hebdomadaire estimé",
  ...
  ru: {
    ...
    msg: {
      checking: "Проверка...",
      empty: "Пожалуйста, введите вашу электронную почту!",
      server_error: "Ошибка сервера. Попробуйте еще раз.",
      invalid: "Нет доступа для этого email.",
      not_found: "Доступ не найден. Сначала оплатите или проверьте email.",
      valid: "✅ Доступ получен! Теперь вы можете скачивать неограниченное количество PDF:"
    },
    "btn.generate": "Создать PDF",
    "export.title": "Скачать PDF",
    "export.sub": "Ваш план, рецепты и список покупок",
    ...
    "btn.switchAccount": "Изменить аккаунт",
    ...
    "pw.lunch": "Обед",
    "pw.dinner": "Ужин",
    "pw.ovDays": "Дней запланировано",
    "pw.ovTime": "Среднее время",
    "pw.ovCost": "Оценочная стоимость",
    "pw.ovCuisines": "Кухни",
    "col.origin": "Страна",
    "col.ingredients": "Ингредиенты",
    "howIsMade": "Как готовится:",
    shoppingList: "Список покупок",
    "shopping.teaser.desc": "Автоматически сгруппирован по категориям и готов к покупкам в PDF.",
    "shopping.empty": "Добавьте блюда для создания списка",
    maxed: "Достигнут лимит бесплатных PDF.<br>Оплатите, чтобы разблокировать неограниченные загрузки!",
    "pdf.free.label": "Бесплатный просмотр — 2 из 7 дней",
    "pdf.locked.title": "🔒 Дни 3 – 7 доступны с Premium",
    "pdf.locked.sub": "Разблокируйте полный 7-дневный план с рецептами, ингредиентами и списком покупок.",
    "pdf.locked.cta": "Получить полный доступ →",
    "mode.meal": "Одно блюдо", "mode.day": "Один день", "mode.week": "Одна неделя",
    "mode.heading.meal": "Выбрать блюдо", "mode.heading.day": "План на сегодня", "mode.heading.week": "План на неделю",
    "mode.btn.meal": "✨ Удиви меня!", "mode.btn.day": "Сгенерировать день", "mode.btn.week": "Сгенерировать неделю",
    "mode.col.meal": "Предлагаемое блюдо", "today": "Сегодня",
    ...
    "costEstimate": "Оценочная стоимость",
    "perWeek": "неделя · 2 человека",
    "estWeeklyCost": "Оценочная стоимость недели",
  ...
  zh: {
    ...
    msg: {
      ...
      invalid: "没有找到有效的访问权限。",
      not_found: "没有访问权限，请先付款或检查电子邮件。",
      valid: "✅ 访问已授权！您现在可以无限下载 PDF 文件："
    },
    "btn.generate": "生成 PDF",
    "export.title": "下载 PDF",
    "export.sub": "您的计划、食谱和购物清单",
    "btn.pay": "高级版 – €3/月",
    "btn.autoMenu": "生成随机菜单",
    "budget.toggle": "省钱菜单（危机模式）",
    "btn.verify": "验证邮箱",
    "btn.switchAccount": "切换账户",
    "btn.download": "下载 PDF",
    "col.day": "日期",
    "col.lunch": "午餐（食材）",
    "col.dinner": "晚餐（食材）",
    ...
    "howIsMade": "做法：",
    shoppingList: "购物清单",
    "shopping.teaser.desc": "自动按类别整理，在 PDF 中即可直接采购。",
    "shopping.empty": "添加餐食以生成清单",
    maxed: "已达到免费PDF上限。<br>付费可无限下载！",
    "pdf.free.label": "免费预览 — 7天中的2天",
    "pdf.locked.title": "🔒 第3至7天可通过Premium解锁",
    "pdf.locked.sub": "解锁完整7天计划，含食谱、食材和购物清单。",
    "pdf.locked.cta": "获取完整访问权限 →",
    "mode.meal": "一顿饭", "mode.day": "一天", "mode.week": "一周",
    "mode.heading.meal": "选一道菜", "mode.heading.day": "今日计划", "mode.heading.week": "本周计划",
    "mode.btn.meal": "✨ 随机推荐！", "mode.btn.day": "生成今日菜单", "mode.btn.week": "生成本周菜单",
    "mode.col.meal": "推荐菜肴", "today": "今天",
  ...
  ja: {
    ...
    msg: {
      ...
      invalid: "有効なアクセスが見つかりません。",
      not_found: "アクセスが見つかりません。先に支払うか、メールを確認してください。",
      valid: "✅ アクセス許可！無制限にPDFをダウンロードできます："
    },
    "btn.generate": "PDFを作成",
    "export.title": "PDFをダウンロード",
    "export.sub": "プラン、レシピ、ショッピングリスト",
    "btn.pay": "プレミアム – €3/月",
    "btn.autoMenu": "ランダムメニューを作成",
    "budget.toggle": "節約メニュー（危機モード）",
    "btn.verify": "メールを確認する",
    "btn.switchAccount": "アカウントを切り替える",
    ...
    "howIsMade": "作り方：",
    shoppingList: "買い物リスト",
    "shopping.teaser.desc": "カテゴリーごとに自動整理され、PDFですぐ買い物できます。",
    "shopping.empty": "食事を追加してリストを作成",
    maxed: "無料PDFの上限に達しました。<br>無制限ダウンロードは有料！",
    "pdf.free.label": "無料プレビュー — 7日中2日",
    "pdf.locked.title": "🔒 3〜7日目はPremiumで利用可能",
    "pdf.locked.sub": "レシピ・食材・買い物リスト付きの7日間フルプランを解除。",
    "pdf.locked.cta": "フルアクセスを取得 →",
    "mode.meal": "1食分", "mode.day": "1日分", "mode.week": "1週間",
    "mode.heading.meal": "1食を選ぶ", "mode.heading.day": "今日のプラン", "mode.heading.week": "今週のプラン",
    "mode.btn.meal": "✨ サプライズ！", "mode.btn.day": "今日を生成", "mode.btn.week": "今週を生成",
    "mode.col.meal": "おすすめの料理", "today": "今日",
  ...
  pt: {
    ...
    msg: {
      ...
      invalid: "Nenhum acesso válido encontrado para este e-mail.",
      not_found: "Nenhum acesso encontrado. Pague primeiro ou verifique o e-mail.",
      valid: "✅ Acesso concedido! Agora você pode baixar PDFs ilimitados:"
    },
    "btn.generate": "Gerar PDF",
    "export.title": "Baixar PDF",
    "export.sub": "Seu plano, receitas e lista de compras",
    "btn.pay": "Premium – €3/mês",
    "btn.autoMenu": "Gerar menu aleatório",
    "budget.toggle": "Menu econômico (modo crise)",
    "btn.verify": "Verificar Email",
    "btn.switchAccount": "Trocar conta",
    ...
    "pw.lunch": "Almoço",
    "pw.dinner": "Jantar",
    "pw.ovDays": "Dias planeados",
    "pw.ovTime": "Tempo médio",
    "pw.ovCost": "Custo estimado",
    "pw.ovCuisines": "Cozinhas",
    "col.origin": "País",
    "col.ingredients": "Ingredientes",
    "howIsMade": "Como se faz:",
    shoppingList: "Lista de Compras",
    "shopping.teaser.desc": "Organizada automaticamente por categorias e pronta para comprar no PDF.",
    "shopping.empty": "Adicione refeições para gerar sua lista",
    maxed: "Você atingiu o limite de PDFs gratuitos.<br>Pague para desbloquear downloads ilimitados!",
    "pdf.free.label": "Pré-visualização gratuita — 2 de 7 dias",
    "mode.meal": "Uma refeição", "mode.day": "Um dia", "mode.week": "Uma semana",
    "mode.heading.meal": "Escolher refeição", "mode.heading.day": "Plano de hoje", "mode.heading.week": "Plano semanal",
    "mode.btn.meal": "✨ Surpreenda-me!", "mode.btn.day": "Gerar dia", "mode.btn.week": "Gerar semana",
    "mode.col.meal": "Refeição sugerida", "today": "Hoje",
    "pdf.locked.title": "🔒 Os dias 3 – 7 estão disponíveis com Premium",
    "pdf.locked.sub": "Desbloqueie o plano completo de 7 dias com receitas, ingredientes e lista de compras.",
    "pdf.locked.cta": "Obter acesso completo →",
    ...
    "perWeek": "semana · 2 pessoas",
    "estWeeklyCost": "Custo semanal estimado",
    ...
    "mealsFound": "refeições encontradas",
  ...
  de: {
    ...
    msg: {
      ...
      invalid: "Kein gültiger Zugang für diese E-Mail gefunden.",
      not_found: "Kein Zugang gefunden. Bitte zuerst bezahlen oder E-Mail prüfen.",
      valid: "✅ Zugriff gewährt! Du kannst nun unbegrenzt PDFs herunterladen:"
    },
    "btn.generate": "PDF erstellen",
    "export.title": "PDF herunterladen",
    "export.sub": "Ihr Plan, Rezepte & Einkaufsliste",
    ...
    "btn.switchAccount": "Konto wechseln",
    "btn.download": "PDF herunterladen",
    "col.day": "Tag",
    "col.lunch": "Mittagessen (Zutaten)",
    "col.dinner": "Abendessen (Zutaten)",
    "pw.lunch": "Mittagessen",
    "pw.dinner": "Abendessen",
    "pw.ovDays": "Geplante Tage",
    "pw.ovTime": "Ø Zeit",
    "pw.ovCost": "Geschätzte Kosten",
    "pw.ovCuisines": "Küchen",
    "col.origin": "Land",
    "col.ingredients": "Zutaten",
    "howIsMade": "So wird's gemacht:",
    shoppingList: "Einkaufsliste",
    "shopping.teaser.desc": "Automatisch nach Kategorien sortiert und einkaufsfertig im PDF.",
    "shopping.empty": "Mahlzeiten hinzufügen, um die Liste zu erstellen",
    maxed: "Du hast das Limit kostenloser PDFs erreicht.<br>Zahle für unbegrenzte Downloads!",
    "pdf.free.label": "Kostenlose Vorschau — 2 von 7 Tagen",
    "mode.meal": "Eine Mahlzeit", "mode.day": "Ein Tag", "mode.week": "Eine Woche",
    "mode.heading.meal": "Mahlzeit wählen", "mode.heading.day": "Plan für heute", "mode.heading.week": "Wochenplan",
    "mode.btn.meal": "✨ Überrasch mich!", "mode.btn.day": "Tag generieren", "mode.btn.week": "Woche generieren",
    "mode.col.meal": "Vorgeschlagenes Gericht", "today": "Heute",
    "pdf.locked.title": "🔒 Tage 3 – 7 sind mit Premium verfügbar",
    "pdf.locked.sub": "Schalte den vollständigen 7-Tage-Plan mit Rezepten, Zutaten und Einkaufsliste frei.",
    "pdf.locked.cta": "Vollen Zugang erhalten →",
    ...
    "perWeek": "Woche · 2 Personen",
    "estWeeklyCost": "Geschätzte Wochenkosten",
    ...
    "mealsFound": "Mahlzeiten gefunden",
  ...
  ar: {
    ...
    msg: {
      ...
      invalid: "لا يوجد وصول صالح لهذا البريد الإلكتروني.",
      not_found: "لا يوجد وصول. يرجى الدفع أولاً أو التحقق من البريد الإلكتروني.",
      valid: "✅ تم منح الوصول! يمكنك الآن تنزيل ملفات PDF غير محدودة:"
    },
    "btn.generate": "إنشاء PDF",
    "export.title": "تحميل PDF",
    "export.sub": "خطتك ووصفاتك وقائمة التسوق",
    ...
    "btn.switchAccount": "تبديل الحساب",
    ...
    "pw.lunch": "الغداء",
    "pw.dinner": "العشاء",
    "pw.ovDays": "أيام مخططة",
    "pw.ovTime": "متوسط الوقت",
    "pw.ovCost": "التكلفة المقدرة",
    "pw.ovCuisines": "مطابخ",
    "col.origin": "الدولة",
    "col.ingredients": "المكونات",
    "howIsMade": "طريقة التحضير:",
    shoppingList: "قائمة التسوق",
    "shopping.teaser.desc": "منظَّمة تلقائيًا حسب الفئات وجاهزة للتسوق في PDF.",
    "shopping.empty": "أضف وجبات لإنشاء قائمتك",
    maxed: "لقد وصلت إلى الحد الأقصى من ملفات PDF المجانية.<br>ادفع لتحميل غير محدود!",
    "pdf.free.label": "معاينة مجانية — يومان من أصل 7",
    "mode.meal": "وجبة واحدة", "mode.day": "يوم واحد", "mode.week": "أسبوع واحد",
    "mode.heading.meal": "اختر وجبة", "mode.heading.day": "خطة اليوم", "mode.heading.week": "خطة الأسبوع",
    "mode.btn.meal": "✨ فاجئني!", "mode.btn.day": "توليد اليوم", "mode.btn.week": "توليد الأسبوع",
    "mode.col.meal": "الوجبة المقترحة", "today": "اليوم",
    "pdf.locked.title": "🔒 الأيام 3 – 7 متاحة مع Premium",
    "pdf.locked.sub": "افتح الخطة الكاملة لـ 7 أيام مع الوصفات والمكونات وقائمة التسوق.",
    "pdf.locked.cta": "احصل على الوصول الكامل →",
    ...
    "costEstimate": "التكلفة المقدرة",
    "perWeek": "أسبوع · شخصان",
    "estWeeklyCost": "التكلفة الأسبوعية المقدرة",
  ...
  hi: {
    ...
    msg: {
      ...
      empty: "कृपया अपना ईमेल दर्ज करें!",
      server_error: "सर्वर त्रुटि। कृपया पुनः प्रयास करें।",
      invalid: "इस ईमेल के लिए कोई वैध एक्सेस नहीं मिला।",
      not_found: "कोई एक्सेस नहीं मिला। पहले भुगतान करें या ईमेल जांचें।",
      valid: "✅ पहुँच प्राप्त! आप अनलिमिटेड PDF डाउनलोड कर सकते हैं:"
    },
    "btn.generate": "PDF बनाएँ",
    "export.title": "PDF डाउनलोड करें",
    "export.sub": "आपकी योजना, व्यंजन और खरीदारी सूची",
    "btn.pay": "प्रीमियम – €3/माह",
    "btn.autoMenu": "रैंडम मेनू बनाएं",
    "budget.toggle": "कम बजट मेनू (क्राइसिस मोड)",
    "btn.verify": "ईमेल सत्यापित करें",
    "btn.switchAccount": "खाता बदलें",
    "btn.download": "PDF डाउनलोड करें",
    "col.day": "दिन",
    "col.lunch": "दोपहर का भोजन (सामग्री)",
    "col.dinner": "रात का खाना (सामग्री)",
    "pw.lunch": "दोपहर का भोजन",
    "pw.dinner": "रात का खाना",
    "pw.ovDays": "नियोजित दिन",
    "pw.ovTime": "औसत समय",
    "pw.ovCost": "अनुमानित लागत",
    "pw.ovCuisines": "व्यंजन शैलियाँ",
    "col.origin": "देश",
    "col.ingredients": "सामग्री",
    "howIsMade": "कैसे बनाते हैं:",
    shoppingList: "खरीदारी की सूची",
    "shopping.teaser.desc": "श्रेणियों के अनुसार स्वचालित रूप से व्यवस्थित और PDF में खरीदारी के लिए तैयार।",
    "shopping.empty": "सूची बनाने के लिए भोजन जोड़ें",
    maxed: "आपने मुफ्त PDF की अधिकतम सीमा तक पहुँच गए हैं।<br>अनलिमिटेड डाउनलोड के लिए भुगतान करें!",
    "pdf.free.label": "मुफ्त पूर्वावलोकन — 7 में से 2 दिन",
    "mode.meal": "एक भोजन", "mode.day": "एक दिन", "mode.week": "एक सप्ताह",
    "mode.heading.meal": "एक भोजन चुनें", "mode.heading.day": "आज की योजना", "mode.heading.week": "साप्ताहिक योजना",
    "mode.btn.meal": "✨ मुझे चौंकाओ!", "mode.btn.day": "दिन बनाएं", "mode.btn.week": "सप्ताह बनाएं",
    "mode.col.meal": "सुझाया गया भोजन", "today": "आज",
    "pdf.locked.title": "🔒 दिन 3 – 7 Premium के साथ उपलब्ध हैं",
    "pdf.locked.sub": "रेसिपी, सामग्री और खरीदारी सूची के साथ पूरा 7-दिन का प्लान अनलॉक करें।",
    "pdf.locked.cta": "पूर्ण पहुँच प्राप्त करें →",
    ...
    "perWeek": "सप्ताह · 2 लोग",
    "estWeeklyCost": "साप्ताहिक अनुमानित लागत",
  ...
  "export.title": "PDF İndir",
  "export.sub": "Planınız, tarifler ve alışveriş listesi",
  "btn.pay": "Premium – €3/ay",
  "btn.autoMenu": "Rastgele menü oluştur",
  "budget.toggle": "Bütçe menüsü (kriz modu)",
  "btn.verify": "E-postayı Doğrula",
  "btn.switchAccount": "Hesabı değiştir",
  "btn.download": "PDF İndir",
  "col.day": "Gün",
  "col.lunch": "Öğle yemeği (malzemeler)",
  "col.dinner": "Akşam yemeği (malzemeler)",
  "pw.lunch": "Öğle yemeği",
  "pw.dinner": "Akşam yemeği",
  "pw.ovDays": "Planlanan günler",
  "pw.ovTime": "Ortalama süre",
  "pw.ovCost": "Tahmini maliyet",
  "pw.ovCuisines": "Mutfaklar",
  "col.origin": "Ülke",
  "col.ingredients": "Malzemeler",
  "howIsMade": "Nasıl yapılır:",
  shoppingList: "Alışveriş Listesi",
  "shopping.teaser.desc": "Otomatik olarak kategorilere göre düzenlenir, PDF'te alışverişe hazır.",
  "shopping.empty": "Liste oluşturmak için yemek ekleyin",
  maxed: "Ücretsiz PDF limitine ulaştınız.<br>Sınırsız indirme için ödeme yapın!",
  "pdf.free.label": "Ücretsiz önizleme — 7 günden 2'si",
  "mode.meal": "Bir öğün", "mode.day": "Bir gün", "mode.week": "Bir hafta",
  "mode.heading.meal": "Öğün seç", "mode.heading.day": "Bugünün planı", "mode.heading.week": "Haftalık plan",
  "mode.btn.meal": "✨ Beni şaşırt!", "mode.btn.day": "Günü oluştur", "mode.btn.week": "Haftayı oluştur",
  "mode.col.meal": "Önerilen yemek", "today": "Bugün",
  "pdf.locked.title": "🔒 3 – 7. günler Premium ile kullanılabilir",
  "pdf.locked.sub": "Tarif, malzeme ve alışveriş listesiyle 7 günlük tam planı açın.",
  "pdf.locked.cta": "Tam erişim al →",
  ...
  "msg.valid": "✅ Erişim onaylandı! Sınırsız PDF indirebilirsiniz:",
    ...
    "perWeek": "hafta · 2 kişi",
    "estWeeklyCost": "Tahmini haftalık maliyet",
...
it: {
  ...
  "export.title": "Scarica PDF",
  "export.sub": "Il tuo piano, ricette e lista della spesa",
  ...
  "btn.switchAccount": "Cambia account",
  ...
  "pw.lunch": "Pranzo",
  "pw.dinner": "Cena",
  "pw.ovDays": "Giorni pianificati",
  "pw.ovTime": "Tempo medio",
  "pw.ovCost": "Costo stimato",
  "pw.ovCuisines": "Cucine",
  "col.origin": "Paese",
  "col.ingredients": "Ingredienti",
  "howIsMade": "Preparazione:",
  shoppingList: "Lista della Spesa",
  "shopping.teaser.desc": "Organizzata automaticamente per categoria e pronta per la spesa nel PDF.",
  "shopping.empty": "Aggiungi pasti per generare la tua lista",
  maxed: "Hai raggiunto il limite di PDF gratuiti.<br>Paga per sbloccare download illimitati!",
  "pdf.free.label": "Anteprima gratuita — 2 giorni su 7",
  "mode.meal": "Un pasto", "mode.day": "Un giorno", "mode.week": "Una settimana",
  "mode.heading.meal": "Scegli un pasto", "mode.heading.day": "Piano di oggi", "mode.heading.week": "Piano settimanale",
  "mode.btn.meal": "✨ Sorprendimi!", "mode.btn.day": "Genera la giornata", "mode.btn.week": "Genera la settimana",
  "mode.col.meal": "Pasto suggerito", "today": "Oggi",
  "pdf.locked.title": "🔒 I giorni 3 – 7 sono disponibili con Premium",
  "pdf.locked.sub": "Sblocca il piano completo di 7 giorni con ricette, ingredienti e lista della spesa.",
  "pdf.locked.cta": "Ottieni accesso completo →",
  ...
  "msg.valid": "✅ Accesso confermato! Puoi scaricare PDF illimitati:",
    ...
    "perWeek": "settimana · 2 persone",
    "estWeeklyCost": "Costo settimanale stimato",
...
ko: {
  ...
  "btn.generate": "PDF 생성",
  "export.title": "PDF 다운로드",
  "export.sub": "플랜, 레시피 & 쇼핑 목록",
  "btn.pay": "프리미엄 – €3/월",
  "btn.autoMenu": "랜덤 메뉴 생성",
  "budget.toggle": "절약 메뉴(위기 모드)",
  "btn.verify": "이메일 확인",
  "btn.switchAccount": "계정 전환",
  ...
  "shopping.teaser.desc": "카테고리별로 자동 정리되어 PDF에서 바로 장보기 가능합니다.",
  "shopping.empty": "식사를 추가해 목록을 생성하세요",
  maxed: "무료 PDF 한도에 도달했습니다.<br>무제한 다운로드를 위해 결제하세요!",
  "pdf.free.label": "무료 미리보기 — 7일 중 2일",
  "mode.meal": "한 끼", "mode.day": "하루", "mode.week": "일주일",
  "mode.heading.meal": "한 끼 선택", "mode.heading.day": "오늘의 플랜", "mode.heading.week": "주간 플랜",
  "mode.btn.meal": "✨ 깜짝 추천!", "mode.btn.day": "오늘 생성", "mode.btn.week": "한 주 생성",
  "mode.col.meal": "추천 요리", "today": "오늘",
  "pdf.locked.title": "🔒 3 – 7일은 Premium으로 이용 가능",
  "pdf.locked.sub": "레시피, 재료, 장보기 목록이 포함된 7일 전체 플랜을 잠금 해제하세요.",
  "pdf.locked.cta": "전체 이용권 얻기 →",
...
const MOTIV = {
  ro: [
    "Felicitări! Ai reușit să îți planifici toate mesele săptămânii! 💪 Consistența ta este cheia unui stil de viață sănătos. Continuă așa!",
    "Bună treabă! Un plan clar azi înseamnă mai puțin stres și mai mult timp pentru tine mâine.",
    "Pas cu pas, obiceiurile bune se construiesc. Planul tău de azi contează!",
    "Planificarea este începutul succesului. Azi ai făcut un pas mare spre obiectivele tale!",
    "Fiecare masă planificată este un pas spre o viață mai echilibrată.",
    "Ai grijă de tine, un plan bun înseamnă sănătate pe termen lung.",
    "Disciplina de azi este libertatea de mâine. Bravo!",
    "Ai transformat intențiile în acțiuni. Continuă să faci asta!",
    "Planificarea ta arată determinare și grijă pentru tine și cei dragi.",
    "Un plan bun este ca o hartă — te duce exact unde vrei să ajungi."
  ],
  en: [
    "Great job! You planned all your meals for the week! 💪 Consistency is your superpower—keep going!",
    "Nice work! A clear plan today means less stress and more time tomorrow.",
    "Step by step, good habits stick. Today’s plan matters!",
    "Planning is the first step to success. You’ve nailed it today!",
    "Every planned meal is a step toward a balanced life.",
    "Take care of yourself—good planning means long-term health.",
    "Discipline today is freedom tomorrow. Well done!",
    "You turned intentions into actions. Keep it up!",
    "Your planning shows determination and care for yourself and loved ones.",
    "A good plan is like a map—it gets you exactly where you want to go."
  ],
  es: [
    "¡Felicidades! ¡Has planificado todas tus comidas de la semana! 💪 La constancia es la clave. ¡Sigue así!",
    "¡Buen trabajo! Un plan claro hoy significa menos estrés mañana.",
    "Paso a paso, los buenos hábitos se construyen. ¡Tu plan cuenta!",
    "Planificar es el primer paso hacia el éxito. ¡Lo lograste hoy!",
    "Cada comida planificada es un paso hacia una vida equilibrada.",
    "Cuídate: una buena planificación significa salud a largo plazo.",
    "La disciplina de hoy es la libertad de mañana. ¡Bien hecho!",
    "Has convertido las intenciones en acciones. ¡Sigue así!",
    "Tu planificación muestra determinación y cuidado por ti y tus seres queridos.",
    "Un buen plan es como un mapa: te lleva justo donde quieres llegar."
  ],
  fr: [
    "Bravo ! Tu as planifié tous tes repas de la semaine ! 💪 La constance fait la différence. Continue !",
    "Super travail ! Un plan clair aujourd’hui = moins de stress demain.",
    "Pas à pas, les bonnes habitudes s’installent. Ton plan compte !",
    "Planifier est la première étape vers le succès. Tu as réussi aujourd’hui !",
    "Chaque repas planifié est un pas vers une vie équilibrée.",
    "Prends soin de toi : une bonne planification signifie santé sur le long terme.",
    "La discipline d’aujourd’hui est la liberté de demain. Bravo !",
    "Tu as transformé tes intentions en actions. Continue comme ça !",
    "Ta planification montre ta détermination et ton attention pour toi et tes proches.",
    "Un bon plan, c’est comme une carte : il t’emmène là où tu veux aller."
  ],
  de: [
    "Stark! Deine Wochenmahlzeiten stehen! 💪 Dranbleiben ist der Schlüssel. Weiter so!",
    "Gute Arbeit! Ein klarer Plan heute heißt weniger Stress morgen.",
    "Schritt für Schritt werden gute Gewohnheiten gefestigt. Dein Plan zählt!",
    "Planung ist der erste Schritt zum Erfolg. Heute hast du es geschafft!",
    "Jede geplante Mahlzeit ist ein Schritt zu einem ausgewogenen Leben.",
    "Kümmere dich um dich: Gute Planung bedeutet langfristige Gesundheit.",
    "Disziplin heute ist Freiheit morgen. Gut gemacht!",
    "Du hast Absichten in Taten umgesetzt. Mach weiter so!",
    "Deine Planung zeigt Entschlossenheit und Fürsorge für dich und deine Lieben.",
    "Ein guter Plan ist wie eine Landkarte – er bringt dich genau ans Ziel."
  ],
  pt: [
    "Parabéns! Planeaste as refeições da semana! 💪 A consistência é a chave. Continua!",
    "Bom trabalho! Um plano claro hoje = menos stress amanhã.",
    "Passo a passo, os bons hábitos ficam. O teu plano conta!",
    "Planear é o primeiro passo para o sucesso. Hoje conseguiste!",
    "Cada refeição planeada é um passo para uma vida equilibrada.",
    "Cuida de ti: um bom planeamento significa saúde a longo prazo.",
    "A disciplina de hoje é a liberdade de amanhã. Muito bem!",
    "Transformaste intenções em ações. Continua assim!",
    "O teu planeamento mostra determinação e cuidado contigo e com os teus.",
    "Um bom plano é como um mapa – leva-te exatamente onde queres chegar."
  ],
  ru: [
    "Отлично! Ты распланировал(а) питание на неделю! 💪 Постоянство — твоя сила. Продолжай!",
    "Хорошая работа! Чёткий план сегодня — меньше стресса завтра.",
    "Шаг за шагом прививаются полезные привычки. Твой план важен!",
    "Планирование — первый шаг к успеху. Сегодня ты это сделал(а)!",
    "Каждый запланированный приём пищи — шаг к сбалансированной жизни.",
    "Береги себя: хорошее планирование — это здоровье на долгие годы.",
    "Дисциплина сегодня — свобода завтра. Молодец!",
    "Ты превратил(а) намерения в действия. Продолжай!",
    "Твоё планирование показывает решимость и заботу о себе и близких.",
    "Хороший план — как карта: ведёт тебя прямо к цели."
  ],
  ar: [
    "أحسنت! لقد خططت لوجبات الأسبوع! 💪 الاستمرارية هي سر النجاح. واصل!",
    "عمل رائع! الخطة الواضحة اليوم تعني توتراً أقل غداً.",
    "خطوة بخطوة تُبنى العادات الجيدة. خطتك مهمة!",
    "التخطيط هو الخطوة الأولى نحو النجاح. لقد أنجزت اليوم!",
    "كل وجبة مخططة هي خطوة نحو حياة متوازنة.",
    "اعتن بنفسك: التخطيط الجيد يعني صحة طويلة الأمد.",
    "انضباط اليوم هو حرية الغد. أحسنت!",
    "لقد حوّلت النوايا إلى أفعال. استمر!",
    "تُظهر خطتك الإصرار والاهتمام بنفسك وبأحبائك.",
    "الخطة الجيدة مثل الخريطة – توصلك مباشرةً إلى هدفك."
  ],
  zh: [
    "太棒了！你已完成本周所有餐食的计划！💪 持之以恒就是力量，继续加油！",
    "做得好！今天有清晰计划，明天更轻松。",
    "一步一步，好习惯就会养成。你的计划很重要！",
    "计划是成功的第一步。今天你做到了！",
    "每一餐的计划都是迈向均衡生活的一步。",
    "关爱自己：良好的计划意味着长期健康。",
    "今天的自律就是明天的自由。干得好！",
    "你把想法变成了行动。继续保持！",
    "你的计划展现了你的决心和对自己及家人的关心。",
    "好的计划就像地图——带你到达想去的地方。"
  ],
  ja: [
    "すばらしい！今週の食事計画はバッチリ！💪 継続は力なり。その調子！",
    "いいね！今日の明確な計画は、明日の負担を減らす。",
    "一歩ずつ、良い習慣は身につく。今日の計画が大切！",
    "計画は成功への第一歩。今日はやり遂げたね！",
    "計画された食事は、バランスの取れた生活への一歩。",
    "自分を大切に：良い計画は長期的な健康につながる。",
    "今日の規律は明日の自由。よくやった！",
    "意図を行動に変えたね。続けよう！",
    "あなたの計画は、あなたと大切な人への思いやりを示している。",
    "良い計画は地図のように—行きたい場所へ導いてくれる。"
  ],
  hi: [
    "शाबाश! आपने हफ्ते का पूरा मील प्लान बना लिया! 💪 निरंतरता ही ताकत है—जारी रखें!",
    "बहुत बढ़िया! आज की साफ़ योजना, कल का कम तनाव।",
    "एक-एक कदम, अच्छी आदतें बनती हैं। आपका प्लान मायने रखता है!",
    "योजना सफलता की पहली सीढ़ी है। आपने आज इसे पूरा किया!",
    "हर योजना बनाई गई भोजन एक संतुलित जीवन की ओर कदम है।",
    "अपना ख्याल रखें: अच्छी योजना का मतलब है लंबी अवधि की सेहत।",
    "आज का अनुशासन कल की आज़ादी है। बहुत बढ़िया!",
