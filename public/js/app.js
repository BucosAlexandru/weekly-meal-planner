  ...
  const copy = {
    ro: { eyebrow:'Cu Premium', title:'Vezi ce deblochezi cu €3/lună', sub:'Trei lucruri concrete pe care le primești când treci la Premium.',
      cards: [
        ...
        { ico:'🌍', title:'216 rețete • 70+ țări', desc:'Acces la rețete din bucătării din întreaga lume — de la clasicii italieni și grecești la favoritele thailandeze, japoneze și din Orientul Mijlociu.',
          mock:'Italia • Grecia • Japonia • Thailanda • Mexic • India...' },
    ...
    en: { eyebrow:'With Premium', title:'See what €3/month unlocks', sub:'Three concrete things you get when you upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'216 recipes • 70+ countries', desc:'Access recipes from cuisines around the world — from Italian and Greek classics to Thai, Japanese and Middle Eastern favorites.',
          mock:'Italy • Greece • Japan • Thailand • Mexico • India...' },
    ...
    es: { eyebrow:'Con Premium', title:'Mira qué desbloqueas con €3/mes', sub:'Tres cosas concretas que obtienes al pasar a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'216 recetas • 70+ países', desc:'Acceso a recetas de cocinas de todo el mundo — desde clásicos italianos y griegos hasta favoritos tailandeses, japoneses y de Medio Oriente.',
          mock:'Italia • Grecia • Japón • Tailandia • México • India...' },
    ...
    fr: { eyebrow:'Avec Premium', title:'Voyez ce que €3/mois débloque', sub:'Trois choses concrètes que vous obtenez en passant à Premium.',
      cards: [
        ...
        { ico:'🌍', title:'216 recettes • 70+ pays', desc:'Accédez à des recettes du monde entier — des classiques italiens et grecs aux favoris thaïlandais, japonais et du Moyen-Orient.',
          mock:'Italie • Grèce • Japon • Thaïlande • Mexique • Inde...' },
    ...
    de: { eyebrow:'Mit Premium', title:'Schau, was €3/Monat freischaltet', sub:'Drei konkrete Dinge, die du beim Upgrade bekommst.',
      cards: [
        ...
        { ico:'🌍', title:'216 Rezepte • 70+ Länder', desc:'Rezepte aus Küchen rund um die Welt — von italienischen und griechischen Klassikern bis zu thailändischen, japanischen und nahöstlichen Favoriten.',
          mock:'Italien • Griechenland • Japan • Thailand • Mexiko • Indien...' },
    ...
    pt: { eyebrow:'Com Premium', title:'Veja o que €3/mês desbloqueia', sub:'Três coisas concretas que recebe ao fazer upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'216 receitas • 70+ países', desc:'Acesso a receitas de cozinhas do mundo todo — dos clássicos italianos e gregos aos favoritos tailandeses, japoneses e do Oriente Médio.',
          mock:'Itália • Grécia • Japão • Tailândia • México • Índia...' },
    ...
    ru: { eyebrow:'С Премиум', title:'Что разблокирует €3/мес', sub:'Три конкретные вещи, которые вы получаете при обновлении.',
      cards: [
        ...
        { ico:'🌍', title:'216 рецептов • 70+ стран', desc:'Рецепты со всего мира — от классической итальянской и греческой кухни до тайских, японских и ближневосточных фаворитов.',
          mock:'Италия • Греция • Япония • Таиланд • Мексика • Индия...' },
    ...
    it: { eyebrow:'Con Premium', title:'Scopri cosa sblocchi con €3/mese', sub:'Tre cose concrete che ottieni passando a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'216 ricette • 70+ paesi', desc:'Accesso a ricette da cucine di tutto il mondo — dai classici italiani e greci ai preferiti thailandesi, giapponesi e mediorientali.',
          mock:'Italia • Grecia • Giappone • Thailandia • Messico • India...' },
    ...
    tr: { eyebrow:'Premium ile', title:'€3/ay ile neyin kilidini açtığını gör', sub:'Yükselttiğinde aldığın üç somut şey.',
      cards: [
        ...
        { ico:'🌍', title:'216 tarif • 70+ ülke', desc:'Dünyanın dört bir yanından mutfaklara erişim — İtalyan ve Yunan klasiklerinden Tayland, Japon ve Orta Doğu favorilerine kadar.',
          mock:'İtalya • Yunanistan • Japonya • Tayland • Meksika • Hindistan...' },
    ...
    ar: { eyebrow:'مع بريميوم', title:'شاهد ماذا يفتح لك €3/شهر', sub:'ثلاثة أشياء ملموسة تحصل عليها عند الترقية.',
      cards: [
        ...
        { ico:'🌍', title:'216 وصفة • أكثر من 70 دولة', desc:'وصفات من مطابخ حول العالم — من الكلاسيكيات الإيطالية واليونانية إلى المفضلات التايلاندية واليابانية والشرق أوسطية.',
          mock:'إيطاليا • اليونان • اليابان • تايلاند • المكسيك • الهند...' },
    ...
    zh: { eyebrow:'通过高级版', title:'看看 €3/月 解锁了什么', sub:'升级后您会获得三样具体的东西。',
      cards: [
        ...
        { ico:'🌍', title:'216 道食谱 • 70+ 国家', desc:'探索来自世界各地的菜系 — 从意大利和希腊经典菜到泰国、日本和中东风味。',
          mock:'意大利 • 希腊 • 日本 • 泰国 • 墨西哥 • 印度...' },
    ...
    ja: { eyebrow:'プレミアムで', title:'€3/月で何が解除されるか見る', sub:'アップグレードで得られる3つの具体的なもの。',
      cards: [
        { ico:'📄', title:'7日間フルPDF', desc:'2日プレビューだけでなく — 7日間すべてのレシピ、食材、完全な買い物リスト。',
          mock:'月 — 火 — 水 — 木 — 金 — 土 — 日' },
        { ico:'🌍', title:'216レシピ • 70カ国以上', desc:'世界中の料理にアクセス — イタリア・ギリシャの定番から、タイ・日本・中東のお気に入りまで。',
          mock:'イタリア • ギリシャ • 日本 • タイ • メキシコ • インド...' },
    ...
    ko: { eyebrow:'프리미엄으로', title:'€3/월이 무엇을 잠금 해제하는지 보세요', sub:'업그레이드 시 얻는 세 가지 구체적인 것.',
      cards: [
        { ico:'📄', title:'7일 전체 PDF', desc:'2일 미리보기만이 아닌 — 레시피, 재료, 전체 장보기 목록이 포함된 7일 전체.',
          mock:'월 — 화 — 수 — 목 — 금 — 토 — 일' },
        { ico:'🌍', title:'216개 레시피 • 70+ 국가', desc:'전 세계 요리에 접근 — 이탈리아 및 그리스 클래식부터 태국, 일본, 중동의 인기 메뉴까지.',
          mock:'이탈리아 • 그리스 • 일본 • 태국 • 멕시코 • 인도...' },
    ...
    hi: { eyebrow:'प्रीमियम के साथ', title:'देखें €3/माह क्या अनलॉक करता है', sub:'अपग्रेड पर आपको मिलने वाली तीन ठोस चीजें।',
      cards: [
        ...
        { ico:'🌍', title:'216 रेसिपी • 70+ देश', desc:'दुनिया भर के व्यंजनों तक पहुँच — इतालवी और यूनानी क्लासिक से लेकर थाई, जापानी और मध्य पूर्वी पसंदीदा तक।',
          mock:'इटली • ग्रीस • जापान • थाईलैंड • मैक्सिको • भारत...' },
