...
// stable across small additions (204 → "425+"). Plans count must match the
...
// (currently 395 main + 35 budget = 430 → 425).
const RECIPE_COUNT_ROUND = 425;
const PLAN_COUNT = 11;
...
function renderDiscovery() {
  ...
  const discoveryCopy = {
    ro: {
      ...
      r_desc: 'Rețete autentice din 48 țări cu ingrediente, mod de preparare, valori nutriționale și sfaturi.',
    ...
    en: {
      ...
      r_desc: 'Authentic recipes from 48 countries with ingredients, instructions, nutrition info and tips.',
    ...
    es: {
      ...
      r_desc: 'Recetas auténticas de 48 países con ingredientes, preparación, nutrición y consejos.',
    ...
    fr: {
      ...
      r_desc: 'Recettes authentiques de 48 pays avec ingrédients, instructions, nutrition et conseils.',
    ...
    de: {
      ...
      r_desc: 'Authentische Rezepte aus 48 Ländern mit Zutaten, Anleitung, Nährwerten und Tipps.',
    ...
    pt: {
      ...
      r_desc: 'Receitas autênticas de 48 países com ingredientes, preparo, nutrição e dicas.',
    ...
    ru: {
      ...
      r_desc: 'Аутентичные рецепты из 48 стран с ингредиентами, приготовлением, нутриентами и советами.',
    ...
    it: {
      ...
      r_desc: 'Ricette autentiche da 48 paesi con ingredienti, preparazione, valori nutrizionali e consigli.',
    ...
    tr: {
      ...
      r_desc: '48 ülkeden otantik tarifler: malzemeler, yapılış, besin değerleri ve ipuçlarıyla.',
    ...
    ar: {
      ...
      r_desc: 'وصفات أصيلة من 48 دولة مع المكونات وطريقة التحضير والقيم الغذائية.',
      r_cta:  'اكتشف الوصفات →',
    },
    zh: {
      title: '探索并获得灵感',
      ...
      r_desc: '来自48国家的正宗食谱，包含食材、做法、营养信息和小贴士。',
      r_cta:  '发现食谱 →',
    },
    ja: {
    ...
    hi: {
      ...
      r_desc: '48 देशों से प्रामाणिक व्यंजन। सामग्री, विधि, पोषण और सुझाव सहित।',
      r_cta:  'व्यंजन खोजें →',
    },
  };
  ...
  const copy = {
    ro: { eyebrow:'Cu Premium', title:'Vezi ce deblochezi cu €3/lună', sub:'Trei lucruri concrete pe care le primești când treci la Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} rețete • 48 țări', desc:'Acces la rețete din bucătării din întreaga lume — de la clasicii italieni și francezi la favoritele thailandeze, japoneze și din Orientul Mijlociu.',
    ...
    en: { eyebrow:'With Premium', title:'See what €3/month unlocks', sub:'Three concrete things you get when you upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recipes • 48 countries', desc:'Access recipes from cuisines around the world — from Italian and French classics to Thai, Japanese and Middle Eastern favorites.',
    ...
    es: { eyebrow:'Con Premium', title:'Mira qué desbloqueas con €3/mes', sub:'Tres cosas concretas que obtienes al pasar a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recetas • 48 países', desc:'Acceso a recetas de cocinas de todo el mundo — desde clásicos italianos y franceses hasta favoritos tailandeses, japoneses y de Medio Oriente.',
    ...
    fr: { eyebrow:'Avec Premium', title:'Voyez ce que €3/mois débloque', sub:'Trois choses concrètes que vous obtenez en passant à Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recettes • 48 pays', desc:'Accédez à des recettes du monde entier — des classiques italiens et français aux favoris thaïlandais, japonais et du Moyen-Orient.',
    ...
    de: { eyebrow:'Mit Premium', title:'Schau, was €3/Monat freischaltet', sub:'Drei konkrete Dinge, die du beim Upgrade bekommst.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} Rezepte • 48 Länder', desc:'Rezepte aus Küchen rund um die Welt — von italienischen und französischen Klassikern bis zu thailändischen, japanischen und nahöstlichen Favoriten.',
    ...
    pt: { eyebrow:'Com Premium', title:'Veja o que €3/mês desbloqueia', sub:'Três coisas concretas que recebe ao fazer upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} receitas • 48 países', desc:'Acesso a receitas de cozinhas do mundo todo — dos clássicos italianos e franceses aos favoritos tailandeses, japoneses e do Oriente Médio.',
    ...
    ru: { eyebrow:'С Премиум', title:'Что разблокирует €3/мес', sub:'Три конкретные вещи, которые вы получаете при обновлении.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} рецептов • 48 стран', desc:'Рецепты со всего мира — от классической итальянской и французской кухни до тайских, японских и ближневосточных фаворитов.',
    ...
    it: { eyebrow:'Con Premium', title:'Scopri cosa sblocchi con €3/mese', sub:'Tre cose concrete che ottieni passando a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} ricette • 48 paesi', desc:'Accesso a ricette da cucine di tutto il mondo — dai classici italiani e francesi ai preferiti thailandesi, giapponesi e mediorientali.',
    ...
    tr: { eyebrow:'Premium ile', title:'€3/ay ile neyin kilidini açtığını gör', sub:'Yükselttiğinde aldığın üç somut şey.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} tarif • 48 ülke', desc:'Dünyanın dört bir yanından mutfaklara erişim — İtalyan ve Fransız klasiklerinden Tayland, Japon ve Orta Doğu favorilerine kadar.',
    ...
    zh: { eyebrow:'通过高级版', title:'看看 €3/月 解锁了什么', sub:'升级后您会获得三样具体的东西。',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} 道食谱 • 48 国家', desc:'探索来自世界各地的菜系 — 从意大利和法国经典菜到泰国、日本和中东风味。',
    ...
    ja: { eyebrow:'プレミアムで', title:'€3/月で何が解除されるか見る', sub:'アップグレードで得られる3つの具体的なもの。',
      cards: [
        { ico:'📄', title:'7日間フルPDF', desc:'2日プレビューだけでなく — 7日間すべてのレシピ、食材、完全な買い物リスト。',
          mock:'月 — 火 — 水 — 木 — 金 — 土 — 日' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}レシピ • 48カ国', desc:'世界中の料理にアクセス — イタリア・フランスの定番から、タイ・日本・中東のお気に入りまで。',
    ...
    ko: { eyebrow:'프리미엄으로', title:'€3/월이 무엇을 잠금 해제하는지 보세요', sub:'업그레이드 시 얻는 세 가지 구체적인 것.',
      cards: [
        { ico:'📄', title:'7일 전체 PDF', desc:'2일 미리보기만이 아닌 — 레시피, 재료, 전체 장보기 목록이 포함된 7일 전체.',
          mock:'월 — 화 — 수 — 목 — 금 — 토 — 일' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}개 레시피 • 48 국가', desc:'전 세계 요리에 접근 — 이탈리아 및 프랑스 클래식부터 태국, 일본, 중동의 인기 메뉴까지.',
    ...
    hi: { eyebrow:'प्रीमियम के साथ', title:'देखें €3/माह क्या अनलॉक करता है', sub:'अपग्रेड पर आपको मिलने वाली तीन ठोस चीजें।',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} रेसिपी • 48 देश', desc:'दुनिया भर के व्यंजनों तक पहुँच — इतालवी और फ्रेंच क्लासिक से लेकर थाई, जापानी और मध्य पूर्वी पसंदीदा तक।',
...
function renderFAQ() {
  ...
  const copy = {
    ro: {
      ...
      items: [
        { q: 'Planificatorul este cu adevărat gratuit?',
          a: 'Da. Planificarea săptămânală, lista de cumpărături și cele 425+ rețete sunt gratuite, fără înregistrare. PDF-ul gratuit oferă o previzualizare de 2 zile din 7.' },
    ...
    en: {
      ...
      items: [
        { q: 'Is the planner really free?',
          a: 'Yes. The weekly planner, shopping list, and 425+ recipes are free with no signup. The free PDF gives you a 2-of-7-day preview.' },
        { q: 'What do I get with Premium?',
          a: 'Full PDF for all 7 days, a weekly budget menu, access to all {{RECIPE_COUNT}} recipes from 48 countries, and new recipes added regularly. €3/month, no commitment.' },
    ...
    es: {
      ...
      items: [
        { q: '¿El planificador es realmente gratis?',
          a: 'Sí. El planificador semanal, la lista de compras y las 425+ recetas son gratuitas sin registro. El PDF gratuito ofrece una vista previa de 2 de 7 días.' },
        { q: '¿Qué incluye Premium?',
          a: 'PDF completo de los 7 días, menú económico semanal, acceso a todas las {{RECIPE_COUNT}} recetas de 48 países y nuevas recetas regularmente. €3/mes, sin compromiso.' },
    ...
    fr: {
      ...
      items: [
        { q: 'Le planificateur est-il vraiment gratuit ?',
          a: 'Oui. Le planificateur hebdomadaire, la liste de courses et les 425+ recettes sont gratuits sans inscription. Le PDF gratuit offre un aperçu de 2 jours sur 7.' },
        { q: 'Que comprend Premium ?',
          a: 'PDF complet 7 jours, menu budget hebdomadaire, accès aux {{RECIPE_COUNT}} recettes de 48 pays et nouvelles recettes ajoutées régulièrement. €3/mois, sans engagement.' },
    ...
    de: {
      ...
      items: [
        { q: 'Ist der Planer wirklich kostenlos?',
          a: 'Ja. Wochenplaner, Einkaufsliste und 425+ Rezepte sind ohne Anmeldung kostenlos. Das kostenlose PDF zeigt eine Vorschau von 2 von 7 Tagen.' },
        { q: 'Was bekomme ich mit Premium?',
          a: 'Vollständiges PDF für alle 7 Tage, wöchentliches Budget-Menü, Zugang zu allen {{RECIPE_COUNT}} Rezepten aus 48 Ländern und regelmäßig neue Rezepte. €3/Monat, ohne Bindung.' },
    ...
    pt: {
      ...
      items: [
        { q: 'O planificador é realmente gratuito?',
          a: 'Sim. O planificador semanal, lista de compras e 425+ receitas são gratuitos sem cadastro. O PDF gratuito oferece uma pré-visualização de 2 de 7 dias.' },
        { q: 'O que recebo com Premium?',
          a: 'PDF completo dos 7 dias, menu económico semanal, acesso às {{RECIPE_COUNT}} receitas de 48 países e novas receitas regularmente. €3/mês, sem compromisso.' },
    ...
    ru: {
      ...
      items: [
        { q: 'Планировщик действительно бесплатный?',
          a: 'Да. Недельный план, список покупок и 425+ рецептов бесплатны без регистрации. Бесплатный PDF показывает превью 2 из 7 дней.' },
        { q: 'Что входит в Премиум?',
          a: 'Полный PDF на все 7 дней, недельное бюджетное меню, доступ ко всем {{RECIPE_COUNT}} рецептам из 48 стран и новые рецепты регулярно. €3/мес, без обязательств.' },
    ...
    it: {
      ...
      items: [
        { q: 'Il pianificatore è davvero gratuito?',
          a: 'Sì. Pianificatore settimanale, lista della spesa e 425+ ricette sono gratis senza registrazione. Il PDF gratuito offre un\'anteprima di 2 giorni su 7.' },
    ...
    tr: {
      ...
      items: [
        { q: 'Planlayıcı gerçekten ücretsiz mi?',
          a: 'Evet. Haftalık planlayıcı, alışveriş listesi ve 425+ tarif kayıt olmadan ücretsizdir. Ücretsiz PDF, 7 günden 2 günlük bir önizleme sunar.' },
        { q: 'Premium ile ne kazanırım?',
          a: 'Tüm 7 günler için tam PDF, haftalık bütçe menüsü, 48 ülkeden {{RECIPE_COUNT}} tarife erişim ve düzenli olarak yeni tarifler. €3/ay, taahhüt yok.' },
    ...
    ar: {
      ...
      items: [
        { q: 'هل المخطط مجاني بالفعل؟',
          a: 'نعم. المخطط الأسبوعي وقائمة التسوق و425+ وصفة مجانية بدون تسجيل. ملف PDF المجاني يعرض معاينة 2 من 7 أيام.' },
    ...
    zh: {
      ...
      items: [
        { q: '规划器真的免费吗？',
          a: '是的。每周规划器、购物清单和425+食谱免费且无需注册。免费PDF提供7天中2天的预览。' },
        { q: '高级版包含什么？',
          a: '7天完整PDF、每周节俭菜单、访问来自48国家的{{RECIPE_COUNT}}道食谱，以及定期添加的新食谱。€3/月，无承诺。' },
        { q: '可以随时取消吗？',
    ...
    ja: {
      ...
      items: [
        ...
        { q: 'プレミアムには何が含まれますか？',
          a: '7日間フルPDF、週間節約メニュー、48カ国から{{RECIPE_COUNT}}のレシピへのアクセス、定期的に追加される新レシピ。€3/月、契約縛りなし。' },
        { q: 'いつでもキャンセルできますか？',
    ...
    ko: {
      ...
      items: [
        ...
        { q: '프리미엄에는 무엇이 포함되나요?',
          a: '7일 전체 PDF, 주간 예산 메뉴, 48 국가의 {{RECIPE_COUNT}}개 레시피 모두 이용, 정기적으로 추가되는 새 레시피. €3/월, 약정 없음.' },
        { q: '언제든 취소할 수 있나요?',
    ...
    hi: {
      ...
      items: [
        { q: 'क्या प्लानर वास्तव में मुफ्त है?',
          a: 'हाँ। साप्ताहिक प्लानर, खरीदारी सूची और 425+ रेसिपी पंजीकरण के बिना मुफ्त हैं। मुफ्त PDF 7 में से 2 दिनों का पूर्वावलोकन प्रदान करता है।' },
        { q: 'प्रीमियम में क्या मिलता है?',
          a: 'सभी 7 दिनों के लिए पूर्ण PDF, साप्ताहिक बजट मेनू, 48 देशों से सभी {{RECIPE_COUNT}} रेसिपी तक पहुँच, और नियमित रूप से जोड़ी जाने वाली नई रेसिपी। €3/माह, कोई प्रतिबद्धता नहीं।' },
...
function renderCuisineDiscover() {
  ...
  // Fully data-driven: whichever 6 origins actually have the most recipes
  // right now win a card, with no fixed slug list to fall out of date.
  // Mirrors buildCuisineHubs() in scripts/generate-content.mjs exactly
  // (min 2 recipes, count DESC, origin.en alpha ASC tie-break) so the
  // client-rendered teaser can never drift from what the static hub pages
  // (and the /{lang}/{recipes}/ index) actually contain.
  const COUNTRY_FLAG = {
  ...
  const cuisineSlug = name => (name || '').toLowerCase().replace(/[^a-z0-9]+/gi, '-').replace(/^-|-$/g, '');

  // recipesMain is lazy-loaded and usually absent on first paint; fall back
  ...
  const top6 = recipesMain.length
    ? Object.entries(
        ...
        .slice(0, 6)
    : TOP6_FALLBACK.map(([origin, count]) => [origin, { length: count }]);
  const cuisines = top6.map(([originEn, recs]) => {
    // recs is a real array of recipe objects on the live-corpus path, or a
    // { length } stub on the fallback path (no recipe objects to sample —
    // name/dishes fall back to the bare origin key / nothing).
    const sampleRecs = Array.isArray(recs) ? recs : [];
    const rep = sampleRecs[0];
    return {
      slug: cuisineSlug(originEn),
  ...
  const copy = {
    ro: { eyebrow:'Bucătării', heading:'Explorează bucătării din toată lumea',
      sub:'48 bucătării internaționale, fiecare cu rețete autentice și planificator gratuit.',
      cta:'Vezi toate cele 48 bucătării' },
    en: { eyebrow:'Cuisines', heading:'Explore cuisines from around the world',
      sub:'48 international cuisines, each with authentic recipes and a free planner.',
      cta:'See all 48 cuisines' },
    es: { eyebrow:'Cocinas', heading:'Explora cocinas del mundo',
      sub:'48 cocinas internacionales, cada una con recetas auténticas y planificador gratuito.',
      cta:'Ver las 48 cocinas' },
    fr: { eyebrow:'Cuisines', heading:'Explorez les cuisines du monde',
      sub:'48 cuisines internationales, chacune avec des recettes authentiques et un planificateur gratuit.',
      cta:'Voir les 48 cuisines' },
    de: { eyebrow:'Küchen', heading:'Entdecke Küchen aus aller Welt',
      sub:'48 internationale Küchen, jede mit authentischen Rezepten und kostenlosem Planer.',
      cta:'Alle 48 Küchen ansehen' },
    pt: { eyebrow:'Cozinhas', heading:'Explore cozinhas de todo o mundo',
      sub:'48 cozinhas internacionais, cada uma com receitas autênticas e planificador gratuito.',
      cta:'Ver todas as 48 cozinhas' },
    ru: { eyebrow:'Кухни', heading:'Откройте кухни со всего мира',
      sub:'48 международных кухонь, каждая с аутентичными рецептами и бесплатным планировщиком.',
      cta:'Посмотреть все 48 кухонь' },
    it: { eyebrow:'Cucine', heading:'Esplora cucine da tutto il mondo',
      sub:'48 cucine internazionali, ognuna con ricette autentiche e pianificatore gratuito.',
      cta:'Vedi tutte le 48 cucine' },
    tr: { eyebrow:'Mutfaklar', heading:'Dünyanın dört bir yanından mutfakları keşfedin',
      sub:'48 uluslararası mutfak, her biri özgün tarifler ve ücretsiz planlayıcı ile.',
      cta:'48 mutfağın tamamına bak' },
    ar: { eyebrow:'المطابخ', heading:'استكشف المطابخ من جميع أنحاء العالم',
      sub:'48 مطبخًا دوليًا، كل منها بوصفات أصيلة ومخطط مجاني.',
      cta:'شاهد كل 48 مطبخًا' },
    zh: { eyebrow:'美食', heading:'探索世界各地的美食',
      sub:'48种国际美食，每一种都有正宗食谱和免费规划器。',
      cta:'查看全部48种美食' },
    ja: { eyebrow:'料理', heading:'世界の料理を探索',
      sub:'48の国際料理、それぞれに本格的なレシピと無料プランナー。',
      cta:'48の料理すべてを見る' },
    ko: { eyebrow:'요리', heading:'세계 각국의 요리 탐험',
      sub:'48가지 국제 요리, 각각 정통 레시피와 무료 플래너 포함.',
      cta:'48가지 요리 모두 보기' },
    hi: { eyebrow:'व्यंजन', heading:'दुनिया भर के व्यंजन देखें',
      sub:'48 अंतर्राष्ट्रीय व्यंजन, हर एक में प्रामाणिक रेसिपी और मुफ्त प्लानर।',
      cta:'सभी 48 व्यंजन देखें' },
  };
  const s = copy[lang] || copy.en;
      ...
      <a class="hp-cuisine-card" href="/${lang}/${rSeg}/${c.slug}/" data-cuisine-atmosphere="${c.atmosphere}">
        ...
        <span class="hp-cuisine-card-body">
          <span class="hp-cuisine-card-top">
            <span class="hp-cuisine-card-name">${safeText(c.name)}</span>
            <span class="hp-cuisine-card-count">${c.count}</span>
          </span>
          <span class="hp-cuisine-card-dishes">${safeText(c.dishes)}</span>
        </span>
      </a>`).join('');
    ...
    const P = {
      ro: { title:'Gratuit vs Premium', freeName:'Gratuit', premName:'⭐ Premium',
            ...
            freeFeats:['✅ Plan de mese 7 zile','✅ Listă de cumpărături automată',
                       '✅ 425+ rețete din 48 țări','✅ Previzualizare gratuită — 2 zile din 7',
                       '✗ PDF cu toate 7 zilele','✗ Meniu buget ieftin'],
            premFeats:['✅ Tot ce e gratuit, plus:','✅ PDF cu toate cele 7 zile',
                       '✅ Meniu buget săptămânal','✅ {{RECIPE_COUNT}} rețete din 48 țări',
      ...
      en: { title:'Free vs Premium', freeName:'Free', premName:'⭐ Premium',
            ...
            freeFeats:['✅ 7-day meal plan','✅ Auto shopping list',
                       '✅ 425+ recipes from 48 countries','✅ Free preview — 2 of 7 days',
                       '✗ Full 7-day PDF','✗ Budget menu'],
            premFeats:['✅ Everything in Free, plus:','✅ Full PDF with all 7 days',
                       '✅ Weekly budget menu','✅ {{RECIPE_COUNT}} recipes from 48 countries',
      ...
      es: { title:'Gratis vs Premium', freeName:'Gratis', premName:'⭐ Premium',
            ...
            freeFeats:['✅ Plan de comidas 7 días','✅ Lista de compras automática',
                       '✅ 425+ recetas de 48 países','✅ Vista previa gratuita — 2 de 7 días',
                       '✗ PDF con los 7 días','✗ Menú económico'],
            premFeats:['✅ Todo lo gratis, más:','✅ PDF completo con 7 días',
                       '✅ Menú económico semanal','✅ {{RECIPE_COUNT}} recetas de 48 países',
      ...
      fr: { title:'Gratuit vs Premium', freeName:'Gratuit', premName:'⭐ Premium',
            ...
            freeFeats:['✅ Plan de repas 7 jours','✅ Liste de courses automatique',
                       '✅ 425+ recettes de 48 pays','✅ Aperçu gratuit — 2 jours sur 7',
                       '✗ PDF avec les 7 jours','✗ Menu budget'],
            premFeats:['✅ Tout le gratuit, plus :','✅ PDF complet sur 7 jours',
                       '✅ Menu budget hebdomadaire','✅ {{RECIPE_COUNT}} recettes de 48 pays',
      ...
      de: { title:'Kostenlos vs Premium', freeName:'Kostenlos', premName:'⭐ Premium',
            ...
            freeFeats:['✅ 7-Tage-Mahlzeitenplan','✅ Automatische Einkaufsliste',
                       '✅ 425+ Rezepte aus 48 Ländern','✅ Kostenlose Vorschau — 2 von 7 Tagen',
                       '✗ PDF mit allen 7 Tagen','✗ Budget-Menü'],
            premFeats:['✅ Alles Kostenlose, plus:','✅ PDF mit allen 7 Tagen',
                       '✅ Wöchentliches Budget-Menü','✅ {{RECIPE_COUNT}} Rezepte aus 48 Ländern',
      ...
      pt: { title:'Gratuito vs Premium', freeName:'Gratuito', premName:'⭐ Premium',
            ...
            freeFeats:['✅ Plano de refeições 7 dias','✅ Lista de compras automática',
                       '✅ 425+ receitas de 48 países','✅ Pré-visualização gratuita — 2 de 7 dias',
                       '✗ PDF com todos os 7 dias','✗ Menu económico'],
            premFeats:['✅ Tudo gratuito, mais:','✅ PDF completo com 7 dias',
                       '✅ Menu económico semanal','✅ {{RECIPE_COUNT}} receitas de 48 países',
      ...
      ru: { title:'Бесплатно vs Премиум', freeName:'Бесплатно', premName:'⭐ Премиум',
            ...
            freeFeats:['✅ План питания на 7 дней','✅ Автоматический список покупок',
                       '✅ 425+ рецептов из 48 стран','✅ Бесплатный просмотр — 2 из 7 дней',
                       '✗ PDF на все 7 дней','✗ Бюджетное меню'],
            premFeats:['✅ Всё из бесплатного, плюс:','✅ Полный PDF на 7 дней',
                       '✅ Недельное бюджетное меню','✅ {{RECIPE_COUNT}} рецептов из 48 стран',
      ...
      ar: { title:'مجاني vs بريميوم', freeName:'مجاني', premName:'⭐ بريميوم',
            ...
            freeFeats:['✅ خطة وجبات 7 أيام','✅ قائمة تسوق تلقائية',
                       '✅ 425+ وصفة من 48 دولة','✅ معاينة مجانية — يومان من أصل 7',
                       '✗ PDF كامل 7 أيام','✗ قائمة الميزانية'],
            premFeats:['✅ كل المجاني، بالإضافة:','✅ PDF كامل بجميع 7 أيام',
                       '✅ قائمة ميزانية أسبوعية','✅ {{RECIPE_COUNT}} وصفة من 48 دولة',
      ...
      zh: { title:'免费 vs 高级版', freeName:'免费', premName:'⭐ 高级版',
            ...
            freeFeats:['✅ 7天餐饮计划','✅ 自动购物清单',
                       '✅ 48国425+道菜谱','✅ 免费预览 — 7天中的2天',
                       '✗ 完整7天PDF','✗ 节俭菜单'],
            premFeats:['✅ 所有免费功能，加上：','✅ 完整7天PDF',
                       '✅ 每周节俭菜单','✅ 来自 48 国家的 {{RECIPE_COUNT}} 道食谱',
                       '✅ 定期添加新食谱','✅ 随时无限访问'] },
      ja: { title:'無料 vs プレミアム', freeName:'無料', premName:'⭐ プレミアム',
            ...
            freeFeats:['✅ 7日間の食事プラン','✅ 自動買い物リスト',
                       '✅ 48カ国425+レシピ','✅ 無料プレビュー — 7日中2日',
                       '✗ 7日分フルPDF','✗ 節約メニュー'],
            premFeats:['✅ 無料のすべて、プラス：','✅ 7日分フルPDF',
                       '✅ 週間節約メニュー','✅ 48カ国から{{RECIPE_COUNT}}のレシピ',
                       '✅ 定期的に新レシピ追加','✅ 無制限アクセス'] },
      tr: { title:'Ücretsiz vs Premium', freeName:'Ücretsiz', premName:'⭐ Premium',
            ...
            freeFeats:['✅ 7 günlük yemek planı','✅ Otomatik alışveriş listesi',
                       '✅ 48 ülkeden 425+ tarif','✅ Ücretsiz önizleme — 7 günden 2\'si',
                       '✗ 7 günlük tam PDF','✗ Bütçe menüsü'],
            premFeats:['✅ Ücretsizin her şeyi, artı:','✅ 7 günlük tam PDF',
                       '✅ Haftalık bütçe menüsü','✅ 48 ülkeden {{RECIPE_COUNT}} tarif',
      ...
      it: { title:'Gratuito vs Premium', freeName:'Gratuito', premName:'⭐ Premium',
            ...
            freeFeats:['✅ Piano pasti 7 giorni','✅ Lista della spesa automatica',
                       '✅ 425+ ricette da 48 paesi','✅ Anteprima gratuita — 2 giorni su 7',
                       '✗ PDF con tutti i 7 giorni','✗ Menu economico'],
            premFeats:['✅ Tutto il gratuito, più:','✅ PDF completo 7 giorni',
                       '✅ Menu economico settimanale','✅ {{RECIPE_COUNT}} ricette da 48 paesi',
      ...
      ko: { title:'무료 vs 프리미엄', freeName:'무료', premName:'⭐ 프리미엄',
            ...
            freeFeats:['✅ 7일 식단 계획','✅ 자동 장보기 목록',
                       '✅ 48개국 425+가지 레시피','✅ 무료 미리보기 — 7일 중 2일',
                       '✗ 7일 전체 PDF','✗ 예산 메뉴'],
            premFeats:['✅ 무료의 모든 것, 추가로:','✅ 7일 전체 PDF',
                       '✅ 주간 예산 메뉴','✅ 48 국가의 {{RECIPE_COUNT}}개 레시피',
      ...
      hi: { title:'मुफ्त vs प्रीमियम', freeName:'मुफ्त', premName:'⭐ प्रीमियम',
            ...
            freeFeats:['✅ 7 दिन का भोजन योजना','✅ स्वचालित खरीदारी सूची',
                       '✅ 48 देशों की 425+ रेसिपी','✅ मुफ्त पूर्वावलोकन — 7 में से 2 दिन',
                       '✗ पूर्ण 7 दिन PDF','✗ बजट मेनू'],
            premFeats:['✅ सब कुछ मुफ्त में, साथ में:','✅ पूर्ण 7 दिन PDF',
                       '✅ साप्ताहिक बजट मेनू','✅ 48 देशों से {{RECIPE_COUNT}} रेसिपी',
