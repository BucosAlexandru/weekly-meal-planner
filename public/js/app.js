...
const NAV_CONTENT_LINKS = {
  ...
  es: { plans: { href: '/es/plan-semanal/',      label: '📅 Menús' },        recipes: { href: '/en/recipes/',              label: '🍽️ Recetas' } },
  fr: { plans: { href: '/fr/plan-semaine/',      label: '📅 Menus' },        recipes: { href: '/en/recipes/',              label: '🍽️ Recettes' } },
  de: { plans: { href: '/de/wochenplan/',        label: '📅 Menüs' },        recipes: { href: '/en/recipes/',              label: '🍽️ Rezepte' } },
  pt: { plans: { href: '/pt/plano-semanal/',     label: '📅 Cardápios' },    recipes: { href: '/en/recipes/',              label: '🍽️ Receitas' } },
  ru: { plans: { href: '/ru/nedelnoe-menyu/',    label: '📅 Меню' },         recipes: { href: '/en/recipes/',              label: '🍽️ Рецепты' } },
  ar: { plans: { href: '/ar/khitat-usbuiya/',   label: '📅 القوائم' },      recipes: { href: '/en/recipes/',              label: '🍽️ وصفات' } },
  zh: { plans: { href: '/zh/zhoujicaidan/',      label: '📅 菜单' },          recipes: { href: '/en/recipes/',              label: '🍽️ 食谱' } },
  ja: { plans: { href: '/ja/weekly-menu/',       label: '📅 メニュー' },      recipes: { href: '/en/recipes/',              label: '🍽️ レシピ' } },
  tr: { plans: { href: '/tr/haftalik-menu/',     label: '📅 Menüler' },      recipes: { href: '/en/recipes/',              label: '🍽️ Tarifler' } },
  it: { plans: { href: '/it/piano-settimanale/', label: '📅 Menù' },         recipes: { href: '/en/recipes/',              label: '🍽️ Ricette' } },
  ko: { plans: { href: '/ko/jugan-menu/',        label: '📅 메뉴' },          recipes: { href: '/en/recipes/',              label: '🍽️ 레시피' } },
  hi: { plans: { href: '/hi/weekly-plan/',       label: '📅 मेनू' },         recipes: { href: '/en/recipes/',              label: '🍽️ व्यंजन' } },
};
