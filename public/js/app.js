...
function renderDiscovery() {
  ...
  const discoveryCopy = {
    ro: {
      ...
      r_desc: 'Rețete autentice din 49 țări cu ingrediente, mod de preparare, valori nutriționale și sfaturi.',
    ...
    en: {
      ...
      r_desc: 'Authentic recipes from 49 countries with ingredients, instructions, nutrition info and tips.',
    ...
    es: {
      ...
      r_desc: 'Recetas auténticas de 49 países con ingredientes, preparación, nutrición y consejos.',
    ...
    fr: {
      ...
      r_desc: 'Recettes authentiques de 49 pays avec ingrédients, instructions, nutrition et conseils.',
    ...
    de: {
      ...
      r_desc: 'Authentische Rezepte aus 49 Ländern mit Zutaten, Anleitung, Nährwerten und Tipps.',
    ...
    pt: {
      ...
      r_desc: 'Receitas autênticas de 49 países com ingredientes, preparo, nutrição e dicas.',
    ...
    ru: {
      ...
      r_desc: 'Аутентичные рецепты из 49 стран с ингредиентами, приготовлением, нутриентами и советами.',
    ...
    it: {
      ...
      r_desc: 'Ricette autentiche da 49 paesi con ingredienti, preparazione, valori nutrizionali e consigli.',
    ...
    tr: {
      ...
      r_desc: '49 ülkeden otantik tarifler: malzemeler, yapılış, besin değerleri ve ipuçlarıyla.',
    ...
    ar: {
      ...
      r_desc: 'وصفات أصيلة من 49 دولة مع المكونات وطريقة التحضير والقيم الغذائية.',
      r_cta:  'اكتشف الوصفات →',
    },
    zh: {
      title: '探索并获得灵感',
      ...
      r_desc: '来自49国家的正宗食谱，包含食材、做法、营养信息和小贴士。',
      r_cta:  '发现食谱 →',
    },
    ja: {
    ...
    hi: {
      ...
      r_desc: '49 देशों से प्रामाणिक व्यंजन। सामग्री, विधि, पोषण और सुझाव सहित।',
      r_cta:  'व्यंजन खोजें →',
    },
  };
  ...
  const copy = {
    ro: { eyebrow:'Cu Premium', title:'Vezi ce deblochezi cu €3/lună', sub:'Trei lucruri concrete pe care le primești când treci la Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} rețete • 49 țări', desc:'Acces la rețete din bucătării din întreaga lume — de la clasicii italieni și francezi la favoritele thailandeze, japoneze și din Orientul Mijlociu.',
    ...
    en: { eyebrow:'With Premium', title:'See what €3/month unlocks', sub:'Three concrete things you get when you upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recipes • 49 countries', desc:'Access recipes from cuisines around the world — from Italian and French classics to Thai, Japanese and Middle Eastern favorites.',
    ...
    es: { eyebrow:'Con Premium', title:'Mira qué desbloqueas con €3/mes', sub:'Tres cosas concretas que obtienes al pasar a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recetas • 49 países', desc:'Acceso a recetas de cocinas de todo el mundo — desde clásicos italianos y franceses hasta favoritos tailandeses, japoneses y de Medio Oriente.',
    ...
    fr: { eyebrow:'Avec Premium', title:'Voyez ce que €3/mois débloque', sub:'Trois choses concrètes que vous obtenez en passant à Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recettes • 49 pays', desc:'Accédez à des recettes du monde entier — des classiques italiens et français aux favoris thaïlandais, japonais et du Moyen-Orient.',
    ...
    de: { eyebrow:'Mit Premium', title:'Schau, was €3/Monat freischaltet', sub:'Drei konkrete Dinge, die du beim Upgrade bekommst.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} Rezepte • 49 Länder', desc:'Rezepte aus Küchen rund um die Welt — von italienischen und französischen Klassikern bis zu thailändischen, japanischen und nahöstlichen Favoriten.',
    ...
    pt: { eyebrow:'Com Premium', title:'Veja o que €3/mês desbloqueia', sub:'Três coisas concretas que recebe ao fazer upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} receitas • 49 países', desc:'Acesso a receitas de cozinhas do mundo todo — dos clássicos italianos e franceses aos favoritos tailandeses, japoneses e do Oriente Médio.',
    ...
    ru: { eyebrow:'С Премиум', title:'Что разблокирует €3/мес', sub:'Три конкретные вещи, которые вы получаете при обновлении.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} рецептов • 49 стран', desc:'Рецепты со всего мира — от классической итальянской и французской кухни до тайских, японских и ближневосточных фаворитов.',
    ...
    it: { eyebrow:'Con Premium', title:'Scopri cosa sblocchi con €3/mese', sub:'Tre cose concrete che ottieni passando a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} ricette • 49 paesi', desc:'Accesso a ricette da cucine di tutto il mondo — dai classici italiani e francesi ai preferiti thailandesi, giapponesi e mediorientali.',
    ...
    tr: { eyebrow:'Premium ile', title:'€3/ay ile neyin kilidini açtığını gör', sub:'Yükselttiğinde aldığın üç somut şey.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} tarif • 49 ülke', desc:'Dünyanın dört bir yanından mutfaklara erişim — İtalyan ve Fransız klasiklerinden Tayland, Japon ve Orta Doğu favorilerine kadar.',
    ...
    zh: { eyebrow:'通过高级版', title:'看看 €3/月 解锁了什么', sub:'升级后您会获得三样具体的东西。',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} 道食谱 • 49 国家', desc:'探索来自世界各地的菜系 — 从意大利和法国经典菜到泰国、日本和中东风味。',
    ...
    ja: { eyebrow:'プレミアムで', title:'€3/月で何が解除されるか見る', sub:'アップグレードで得られる3つの具体的なもの。',
      cards: [
        { ico:'📄', title:'7日間フルPDF', desc:'2日プレビューだけでなく — 7日間すべてのレシピ、食材、完全な買い物リスト。',
          mock:'月 — 火 — 水 — 木 — 金 — 土 — 日' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}レシピ • 49カ国', desc:'世界中の料理にアクセス — イタリア・フランスの定番から、タイ・日本・中東のお気に入りまで。',
    ...
    ko: { eyebrow:'프리미엄으로', title:'€3/월이 무엇을 잠금 해제하는지 보세요', sub:'업그레이드 시 얻는 세 가지 구체적인 것.',
      cards: [
        { ico:'📄', title:'7일 전체 PDF', desc:'2일 미리보기만이 아닌 — 레시피, 재료, 전체 장보기 목록이 포함된 7일 전체.',
          mock:'월 — 화 — 수 — 목 — 금 — 토 — 일' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}개 레시피 • 49 국가', desc:'전 세계 요리에 접근 — 이탈리아 및 프랑스 클래식부터 태국, 일본, 중동의 인기 메뉴까지.',
    ...
    hi: { eyebrow:'प्रीमियम के साथ', title:'देखें €3/माह क्या अनलॉक करता है', sub:'अपग्रेड पर आपको मिलने वाली तीन ठोस चीजें।',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} रेसिपी • 49 देश', desc:'दुनिया भर के व्यंजनों तक पहुँच — इतालवी और फ्रेंच क्लासिक से लेकर थाई, जापानी और मध्य पूर्वी पसंदीदा तक।',
...
function renderCuisineDiscover() {
  ...
  const copy = {
    ro: { eyebrow:'Bucătării', heading:'Explorează bucătării din toată lumea',
      sub:'49 bucătării internaționale, fiecare cu rețete autentice și planificator gratuit.',
      cta:'Vezi toate cele 49 bucătării' },
    en: { eyebrow:'Cuisines', heading:'Explore cuisines from around the world',
      sub:'49 international cuisines, each with authentic recipes and a free planner.',
      cta:'See all 49 cuisines' },
    es: { eyebrow:'Cocinas', heading:'Explora cocinas del mundo',
      sub:'49 cocinas internacionales, cada una con recetas auténticas y planificador gratuito.',
      cta:'Ver las 49 cocinas' },
    fr: { eyebrow:'Cuisines', heading:'Explorez les cuisines du monde',
      sub:'49 cuisines internationales, chacune avec des recettes authentiques et un planificateur gratuit.',
      cta:'Voir les 49 cuisines' },
    de: { eyebrow:'Küchen', heading:'Entdecke Küchen aus aller Welt',
      sub:'49 internationale Küchen, jede mit authentischen Rezepten und kostenlosem Planer.',
      cta:'Alle 49 Küchen ansehen' },
    pt: { eyebrow:'Cozinhas', heading:'Explore cozinhas de todo o mundo',
      sub:'49 cozinhas internacionais, cada uma com receitas autênticas e planificador gratuito.',
      cta:'Ver todas as 49 cozinhas' },
    ru: { eyebrow:'Кухни', heading:'Откройте кухни со всего мира',
      sub:'49 международных кухонь, каждая с аутентичными рецептами и бесплатным планировщиком.',
      cta:'Посмотреть все 49 кухонь' },
    it: { eyebrow:'Cucine', heading:'Esplora cucine da tutto il mondo',
      sub:'49 cucine internazionali, ognuna con ricette autentiche e pianificatore gratuito.',
      cta:'Vedi tutte le 49 cucine' },
    tr: { eyebrow:'Mutfaklar', heading:'Dünyanın dört bir yanından mutfakları keşfedin',
      sub:'49 uluslararası mutfak, her biri özgün tarifler ve ücretsiz planlayıcı ile.',
      cta:'49 mutfağın tamamına bak' },
    ar: { eyebrow:'المطابخ', heading:'استكشف المطابخ من جميع أنحاء العالم',
      sub:'49 مطبخًا دوليًا، كل منها بوصفات أصيلة ومخطط مجاني.',
      cta:'شاهد كل 49 مطبخًا' },
    zh: { eyebrow:'美食', heading:'探索世界各地的美食',
      sub:'49种国际美食，每一种都有正宗食谱和免费规划器。',
      cta:'查看全部49种美食' },
    ja: { eyebrow:'料理', heading:'世界の料理を探索',
      sub:'49の国際料理、それぞれに本格的なレシピと無料プランナー。',
      cta:'49の料理すべてを見る' },
    ko: { eyebrow:'요리', heading:'세계 각국의 요리 탐험',
      sub:'49가지 국제 요리, 각각 정통 레시피와 무료 플래너 포함.',
      cta:'49가지 요리 모두 보기' },
    hi: { eyebrow:'व्यंजन', heading:'दुनिया भर के व्यंजन देखें',
      sub:'49 अंतर्राष्ट्रीय व्यंजन, हर एक में प्रामाणिक रेसिपी और मुफ्त प्लानर।',
      cta:'सभी 49 व्यंजन देखें' },
  };
  const s = copy[lang] || copy.en;
