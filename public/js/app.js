...
function renderDiscovery() {
  ...
  const discoveryCopy = {
    ro: {
      ...
      r_desc: 'Rețete autentice din 46 țări cu ingrediente, mod de preparare, valori nutriționale și sfaturi.',
    ...
    en: {
      ...
      r_desc: 'Authentic recipes from 46 countries with ingredients, instructions, nutrition info and tips.',
    ...
    es: {
      ...
      r_desc: 'Recetas auténticas de 46 países con ingredientes, preparación, nutrición y consejos.',
    ...
    fr: {
      ...
      r_desc: 'Recettes authentiques de 46 pays avec ingrédients, instructions, nutrition et conseils.',
    ...
    de: {
      ...
      r_desc: 'Authentische Rezepte aus 46 Ländern mit Zutaten, Anleitung, Nährwerten und Tipps.',
    ...
    pt: {
      ...
      r_desc: 'Receitas autênticas de 46 países com ingredientes, preparo, nutrição e dicas.',
    ...
    ru: {
      ...
      r_desc: 'Аутентичные рецепты из 46 стран с ингредиентами, приготовлением, нутриентами и советами.',
    ...
    it: {
      ...
      r_desc: 'Ricette autentiche da 46 paesi con ingredienti, preparazione, valori nutrizionali e consigli.',
    ...
    tr: {
      ...
      r_desc: '46 ülkeden otantik tarifler: malzemeler, yapılış, besin değerleri ve ipuçlarıyla.',
    ...
    ar: {
      ...
      r_desc: 'وصفات أصيلة من 46 دولة مع المكونات وطريقة التحضير والقيم الغذائية.',
      r_cta:  'اكتشف الوصفات →',
    },
    zh: {
      title: '探索并获得灵感',
      ...
      r_desc: '来自46国家的正宗食谱，包含食材、做法、营养信息和小贴士。',
      r_cta:  '发现食谱 →',
    },
    ja: {
    ...
    hi: {
      ...
      r_desc: '46 देशों से प्रामाणिक व्यंजन। सामग्री, विधि, पोषण और सुझाव सहित।',
      r_cta:  'व्यंजन खोजें →',
    },
  };
  ...
  const copy = {
    ro: { eyebrow:'Cu Premium', title:'Vezi ce deblochezi cu €3/lună', sub:'Trei lucruri concrete pe care le primești când treci la Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} rețete • 46 țări', desc:'Acces la rețete din bucătării din întreaga lume — de la clasicii italieni și francezi la favoritele thailandeze, japoneze și din Orientul Mijlociu.',
    ...
    en: { eyebrow:'With Premium', title:'See what €3/month unlocks', sub:'Three concrete things you get when you upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recipes • 46 countries', desc:'Access recipes from cuisines around the world — from Italian and French classics to Thai, Japanese and Middle Eastern favorites.',
    ...
    es: { eyebrow:'Con Premium', title:'Mira qué desbloqueas con €3/mes', sub:'Tres cosas concretas que obtienes al pasar a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recetas • 46 países', desc:'Acceso a recetas de cocinas de todo el mundo — desde clásicos italianos y franceses hasta favoritos tailandeses, japoneses y de Medio Oriente.',
    ...
    fr: { eyebrow:'Avec Premium', title:'Voyez ce que €3/mois débloque', sub:'Trois choses concrètes que vous obtenez en passant à Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} recettes • 46 pays', desc:'Accédez à des recettes du monde entier — des classiques italiens et français aux favoris thaïlandais, japonais et du Moyen-Orient.',
    ...
    de: { eyebrow:'Mit Premium', title:'Schau, was €3/Monat freischaltet', sub:'Drei konkrete Dinge, die du beim Upgrade bekommst.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} Rezepte • 46 Länder', desc:'Rezepte aus Küchen rund um die Welt — von italienischen und französischen Klassikern bis zu thailändischen, japanischen und nahöstlichen Favoriten.',
    ...
    pt: { eyebrow:'Com Premium', title:'Veja o que €3/mês desbloqueia', sub:'Três coisas concretas que recebe ao fazer upgrade.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} receitas • 46 países', desc:'Acesso a receitas de cozinhas do mundo todo — dos clássicos italianos e franceses aos favoritos tailandeses, japoneses e do Oriente Médio.',
    ...
    ru: { eyebrow:'С Премиум', title:'Что разблокирует €3/мес', sub:'Три конкретные вещи, которые вы получаете при обновлении.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} рецептов • 46 стран', desc:'Рецепты со всего мира — от классической итальянской и французской кухни до тайских, японских и ближневосточных фаворитов.',
    ...
    it: { eyebrow:'Con Premium', title:'Scopri cosa sblocchi con €3/mese', sub:'Tre cose concrete che ottieni passando a Premium.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} ricette • 46 paesi', desc:'Accesso a ricette da cucine di tutto il mondo — dai classici italiani e francesi ai preferiti thailandesi, giapponesi e mediorientali.',
    ...
    tr: { eyebrow:'Premium ile', title:'€3/ay ile neyin kilidini açtığını gör', sub:'Yükselttiğinde aldığın üç somut şey.',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} tarif • 46 ülke', desc:'Dünyanın dört bir yanından mutfaklara erişim — İtalyan ve Fransız klasiklerinden Tayland, Japon ve Orta Doğu favorilerine kadar.',
    ...
    zh: { eyebrow:'通过高级版', title:'看看 €3/月 解锁了什么', sub:'升级后您会获得三样具体的东西。',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} 道食谱 • 46 国家', desc:'探索来自世界各地的菜系 — 从意大利和法国经典菜到泰国、日本和中东风味。',
    ...
    ja: { eyebrow:'プレミアムで', title:'€3/月で何が解除されるか見る', sub:'アップグレードで得られる3つの具体的なもの。',
      cards: [
        { ico:'📄', title:'7日間フルPDF', desc:'2日プレビューだけでなく — 7日間すべてのレシピ、食材、完全な買い物リスト。',
          mock:'月 — 火 — 水 — 木 — 金 — 土 — 日' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}レシピ • 46カ国', desc:'世界中の料理にアクセス — イタリア・フランスの定番から、タイ・日本・中東のお気に入りまで。',
    ...
    ko: { eyebrow:'프리미엄으로', title:'€3/월이 무엇을 잠금 해제하는지 보세요', sub:'업그레이드 시 얻는 세 가지 구체적인 것.',
      cards: [
        { ico:'📄', title:'7일 전체 PDF', desc:'2일 미리보기만이 아닌 — 레시피, 재료, 전체 장보기 목록이 포함된 7일 전체.',
          mock:'월 — 화 — 수 — 목 — 금 — 토 — 일' },
        { ico:'🌍', title:'{{RECIPE_COUNT}}개 레시피 • 46 국가', desc:'전 세계 요리에 접근 — 이탈리아 및 프랑스 클래식부터 태국, 일본, 중동의 인기 메뉴까지.',
    ...
    hi: { eyebrow:'प्रीमियम के साथ', title:'देखें €3/माह क्या अनलॉक करता है', sub:'अपग्रेड पर आपको मिलने वाली तीन ठोस चीजें।',
      cards: [
        ...
        { ico:'🌍', title:'{{RECIPE_COUNT}} रेसिपी • 46 देश', desc:'दुनिया भर के व्यंजनों तक पहुँच — इतालवी और फ्रेंच क्लासिक से लेकर थाई, जापानी और मध्य पूर्वी पसंदीदा तक।',
  ...
  const copy = {
    ...
    ja: {
      ...
      items: [
        ...
        { q: 'プレミアムには何が含まれますか？',
          a: '7日間フルPDF、週間節約メニュー、46カ国から{{RECIPE_COUNT}}のレシピへのアクセス、定期的に追加される新レシピ。€3/月、契約縛りなし。' },
        { q: 'いつでもキャンセルできますか？',
    ...
    const P = {
      ...
      ja: { title:'無料 vs プレミアム', freeName:'無料', premName:'⭐ プレミアム',
            ...
            freeFeats:['✅ 7日間の食事プラン','✅ 自動買い物リスト',
                       '✅ 46カ国300+レシピ','✅ 無料プレビュー — 7日中2日',
                       '✗ 7日分フルPDF','✗ 節約メニュー'],
            premFeats:['✅ 無料のすべて、プラス：','✅ 7日分フルPDF',
                       '✅ 週間節約メニュー','✅ 46カ国から{{RECIPE_COUNT}}のレシピ',
                       '✅ 定期的に新レシピ追加','✅ 無制限アクセス'] },
      ...
      ko: { title:'무료 vs 프리미엄', freeName:'무료', premName:'⭐ 프리미엄',
            ...
            freeFeats:['✅ 7일 식단 계획','✅ 자동 장보기 목록',
                       '✅ 46개국 300+가지 레시피','✅ 무료 미리보기 — 7일 중 2일',
                       '✗ 7일 전체 PDF','✗ 예산 메뉴'],
